...
if (class_exists('data_exportexcel')) return;

class data_exportexcel extends CModule {

	var $MODULE_ID = 'data.exportexcel';
	...
	public function __construct() {
		...
		$this->MODULE_NAME = GetMessage('DATA_EXPORTEXCEL_MODULE_NAME');
		$this->MODULE_DESCRIPTION = GetMessage('DATA_EXPORTEXCEL_MODULE_DESCRIPTION');
	}
