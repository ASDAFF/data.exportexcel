...
/**
 * DATAPHPExcel_Reader_HTML
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Reader
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Reader_HTML extends DATAPHPExcel_Reader_Abstract implements DATAPHPExcel_Reader_IReader
{
	/**
	 * Input encoding
	 *
	...
	private $_formats = array( 'h1' => array( 'font' => array( 'bold' => true,
							   ...
							   'a'  => array( 'font' => array( 'underline' => true,
															   'color' => array( 'argb' => DATAPHPExcel_Style_Color::COLOR_BLUE,
															                   ),
															 ),
											),	//	Blue underlined
							   'hr' => array( 'borders' => array( 'bottom' => array( 'style' => DATAPHPExcel_Style_Border::BORDER_THIN,
																					 'color' => array( DATAPHPExcel_Style_Color::COLOR_BLACK,
																					                 ),
																				   ),
																),
											),	//	Bottom border
	...
	/**
	 * Create a new DATAPHPExcel_Reader_HTML
	 */
	...
	//	Data Array used for testing only, should write to DATAPHPExcel object on completion of tests
...
//						echo 'END OF TABLE ' , $this->_tableLevel , ' CELL<br />';
	...
	public function loadIntoExisting($pFilename, DATAPHPExcel $objDATAPHPExcel)
	{
		...
		if (!$this->_isValidFormat()) {
			...
			throw new DATAPHPExcel_Reader_Exception($pFilename . " is an Invalid HTML file.");
		}
		...
		if ($loaded === FALSE) {
			throw new DATAPHPExcel_Reader_Exception('Failed to load ',$pFilename,' as a DOM Document');
		}
		...
		$column = 'A';
		$content = '';
		$this->_processDomElement($dom,$objDATAPHPExcel->getActiveSheet(),$row,$column,$content);
...
//		var_dump($this->_dataArray);
	 ...
	 * @return DATAPHPExcel_Reader_HTML
	 */
