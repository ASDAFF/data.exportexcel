...
/**
 * DATAPHPExcel_Worksheet_Protection
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Worksheet_Protection
{
	/**
	 * Sheet
	 *
    ...
    /**
     * Create a new DATAPHPExcel_Worksheet_Protection
     */
    ...
    function setPassword($pValue = '', $pAlreadyHashed = false) {
    	if (!$pAlreadyHashed) {
    		$pValue = DATAPHPExcel_Shared_PasswordHasher::hashPassword($pValue);
    	}
