...
/**
 * DATAPHPExcel_Worksheet_HeaderFooter
 *
 * <code>
 ...
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Worksheet_HeaderFooter
{
	 ...
	 *
	 * @var DATAPHPExcel_Worksheet_HeaderFooterDrawing[]
	 */
	private $_headerFooterImages = array();

    /**
     * Create a new DATAPHPExcel_Worksheet_HeaderFooter
     */
     ...
     *
     * @param DATAPHPExcel_Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws DATAPHPExcel_Exception
     * @return DATAPHPExcel_Worksheet_HeaderFooter
     */
    public function addImage(DATAPHPExcel_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT) {
     ...
     *
     * @param DATAPHPExcel_Worksheet_HeaderFooterDrawing[] $images
     * @throws DATAPHPExcel_Exception
     * @return DATAPHPExcel_Worksheet_HeaderFooter
     */
    public function setImages($images) {
    	if (!is_array($images)) {
    		throw new DATAPHPExcel_Exception('Invalid parameter!');
    	}
     ...
     *
     * @return DATAPHPExcel_Worksheet_HeaderFooterDrawing[]
     */
