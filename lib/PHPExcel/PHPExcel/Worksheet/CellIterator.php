...
/**
 * DATAPHPExcel_Worksheet_CellIterator
 *
 * Used to iterate rows in a DATAPHPExcel_Worksheet
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Worksheet_CellIterator implements Iterator
{
	/**
	 * DATAPHPExcel_Worksheet to iterate
	 *
	 ...
	 *
	 * @param DATAPHPExcel_Worksheet 		$subject
	 * @param int						$rowIndex
	 */
	public function __construct(DATAPHPExcel_Worksheet $subject = null, $rowIndex = 1) {
    ...
    /**
     * Are there any more DATAPHPExcel_Cell instances available?
     *
     * @return boolean
     */
    public function valid() {
        ...
        // position.
        $columnCount = DATAPHPExcel_Cell::columnIndexFromString($this->_subject->getHighestColumn());
