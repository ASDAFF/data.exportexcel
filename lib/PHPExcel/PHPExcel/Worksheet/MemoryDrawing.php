...
/**
 * DATAPHPExcel_Worksheet_MemoryDrawing
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Worksheet_MemoryDrawing extends DATAPHPExcel_Worksheet_BaseDrawing implements DATAPHPExcel_IComparable
{
	/* Rendering functions */
    ...
    /**
     * Create a new DATAPHPExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return DATAPHPExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return DATAPHPExcel_Worksheet_MemoryDrawing
     */
    public function setRenderingFunction($value = DATAPHPExcel_Worksheet_MemoryDrawing::RENDERING_DEFAULT) {
     ...
     * @return DATAPHPExcel_Worksheet_MemoryDrawing
     */
    public function setMimeType($value = DATAPHPExcel_Worksheet_MemoryDrawing::MIMETYPE_DEFAULT) {
