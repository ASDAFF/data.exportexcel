...
/**
 * DATAPHPExcel_Worksheet_AutoFilter_Column
 *
 * @category	DATAPHPExcel
 * @package		DATAPHPExcel_Worksheet
 * @copyright	Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Worksheet_AutoFilter_Column
{
	 ...
	 *
	 * @var array of DATAPHPExcel_Worksheet_AutoFilter_Column_Rule
	 */
	...
	/**
	 * Create a new DATAPHPExcel_Worksheet_AutoFilter_Column
	 *
	 *	@param	string		                   $pColumn		Column (e.g. A)
	 *	@param	DATAPHPExcel_Worksheet_AutoFilter  $pParent		Autofilter for this column
	 */
	public function __construct($pColumn, DATAPHPExcel_Worksheet_AutoFilter $pParent = NULL)
	{
	 ...
	 *
	 * @param DATAPHPExcel_Worksheet_AutoFilter
	 * @return DATAPHPExcel_Worksheet_AutoFilter_Column
	 */
	public function setParent(DATAPHPExcel_Worksheet_AutoFilter $pParent = NULL) {
		$this->_parent = $pParent;
	...
	public function setFilterType($pFilterType = self::AUTOFILTER_FILTERTYPE_FILTER) {
		if (!in_array($pFilterType,self::$_filterTypes)) {
			throw new DATAPHPExcel_Exception('Invalid filter type for column AutoFilter.');
		}
	...
	public function setJoin($pJoin = self::AUTOFILTER_COLUMN_JOIN_OR) {
		...
		if (!in_array($pJoin,self::$_ruleJoins)) {
			throw new DATAPHPExcel_Exception('Invalid rule connection for column AutoFilter.');
		}
	 ...
	 *
	 * @throws	DATAPHPExcel_Exception
	 * @return array of DATAPHPExcel_Worksheet_AutoFilter_Column_Rule
	 */
	 ...
	 * @return	DATAPHPExcel_Worksheet_AutoFilter_Column_Rule
	 */
	public function getRule($pIndex) {
		if (!isset($this->_ruleset[$pIndex])) {
			$this->_ruleset[$pIndex] = new DATAPHPExcel_Worksheet_AutoFilter_Column_Rule($this);
		}
	...
	public function createRule() {
		$this->_ruleset[] = new DATAPHPExcel_Worksheet_AutoFilter_Column_Rule($this);
	 ...
	 *
	 * @param	DATAPHPExcel_Worksheet_AutoFilter_Column_Rule	$pRule
	 * @param	boolean	$returnRule 	Flag indicating whether the rule object or the column object should be returned
	 * @return	DATAPHPExcel_Worksheet_AutoFilter_Column|DATAPHPExcel_Worksheet_AutoFilter_Column_Rule
	 */
	public function addRule(DATAPHPExcel_Worksheet_AutoFilter_Column_Rule $pRule, $returnRule=TRUE) {
