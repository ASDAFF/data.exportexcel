...
/**
 * DATAPHPExcel_Worksheet_ColumnDimension
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Worksheet_ColumnDimension
{
	/**
	 * Column index
	 *
    ...
    /**
     * Create a new DATAPHPExcel_Worksheet_ColumnDimension
     *
    ...
    public function setOutlineLevel($pValue) {
    	if ($pValue < 0 || $pValue > 7) {
    		throw new DATAPHPExcel_Exception("Outline level must range between 0 and 7.");
    	}
