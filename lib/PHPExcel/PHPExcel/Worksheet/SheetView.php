...
/**
 * DATAPHPExcel_Worksheet_SheetView
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Worksheet_SheetView
{
    ...
    /**
     * Create a new DATAPHPExcel_Worksheet_SheetView
     */
	...
	public function setZoomScale($pValue = 100) {
		...
		if (($pValue >= 1) || is_null($pValue)) {
			...
			//throw new DATAPHPExcel_Exception("Scale must be greater than or equal to 1.");
		}
		return $this;
	}
	...
	public function setView($pValue = NULL) {
		...
		if (in_array($pValue, self::$_sheetViewTypes)) {
			...
			throw new DATAPHPExcel_Exception("Invalid sheetview layout type.");
		}
