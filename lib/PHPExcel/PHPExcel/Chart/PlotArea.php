...
/**
 * DATAPHPExcel_Chart_PlotArea
 *
 * @category	DATAPHPExcel
 * @package		DATAPHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Chart_PlotArea
{
	/**
	 * PlotArea Layout
	 *
	 ...
	 * Plot Series
	 *
	 * @var array of DATAPHPExcel_Chart_DataSeries
	 */
	private $_plotSeries = array();

	/**
	 * Create a new DATAPHPExcel_Chart_PlotArea
	 */
	public function __construct(DATAPHPExcel_Chart_Layout $layout = null, $plotSeries = array())
	{
		$this->_layout = $layout;
	 ...
	 *
	 * @return array of DATAPHPExcel_Chart_DataSeries
	 */
	 ...
	 *
	 * @return DATAPHPExcel_Chart_DataSeries
	 */
	 ...
	 * Set Plot Series
	 *
	 * @param [DATAPHPExcel_Chart_DataSeries]
	 */
