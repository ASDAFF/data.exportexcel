...
/**
 * DATAPHPExcel_Chart_Legend
 *
 * @category	DATAPHPExcel
 * @package		DATAPHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Chart_Legend
{
	/** Legend positions */
	...
	/**
	 *	Create a new DATAPHPExcel_Chart_Legend
	 */
	public function __construct($position = self::POSITION_RIGHT, DATAPHPExcel_Chart_Layout $layout = NULL, $overlay = FALSE)
	{
