...
/**
 * DATAPHPExcel_Chart_DataSeriesValues
 *
 * @category	DATAPHPExcel
 * @package		DATAPHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Chart_DataSeriesValues
{
	...
	/**
	 * Create a new DATAPHPExcel_Chart_DataSeriesValues object
	 */
	 ...
	 *								Typical values are:
	 *									DATAPHPExcel_Chart_DataSeriesValues::DATASERIES_TYPE_STRING
	 *										Normally used for axis point values
	 *									DATAPHPExcel_Chart_DataSeriesValues::DATASERIES_TYPE_NUMBER
	 *										Normally used for chart data values
	 * @return	DATAPHPExcel_Chart_DataSeriesValues
	 */
	public function setDataType($dataType = self::DATASERIES_TYPE_NUMBER) {
		if (!in_array($dataType, self::$_dataTypeValues)) {
    		throw new DATAPHPExcel_Chart_Exception('Invalid datatype for chart data series values');
		}
	...
	public function setDataValues($dataValues = array(), $refreshDataSource = TRUE) {
		$this->_dataValues = DATAPHPExcel_Calculation_Functions::flattenArray($dataValues);
	...
	public function refresh(DATAPHPExcel_Worksheet $worksheet, $flatten = TRUE) {
        if ($this->_dataSource !== NULL) {
        	$calcEngine = DATAPHPExcel_Calculation::getInstance($worksheet->getParent());
			$newDataValues = DATAPHPExcel_Calculation::_unwrapResult(
			...
			if ($flatten) {
				$this->_dataValues = DATAPHPExcel_Calculation_Functions::flattenArray($newDataValues);
				...
				$dimensions = DATAPHPExcel_Cell::rangeDimension(str_replace('$','',$cellRange));
