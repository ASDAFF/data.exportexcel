...
/**
 * DATAPHPExcel_RichText_TextElement
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_RichText
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_RichText_TextElement implements DATAPHPExcel_RichText_ITextElement
{
	/**
	 * Text
	 *
    ...
    /**
     * Create a new DATAPHPExcel_RichText_TextElement instance
     *
