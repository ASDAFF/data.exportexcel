...
/**
 * DATAPHPExcel_CalcEngine_Logger
 *
 * @category	DATAPHPExcel
 * @package		DATAPHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_CalcEngine_Logger {
	 ...
	 *
	 * @var DATAPHPExcel_CalcEngine_CyclicReferenceStack
	 */
	private $_cellStack;
	 ...
	 *
	 * @param  DATAPHPExcel_CalcEngine_CyclicReferenceStack $stack
	 */
	public function __construct(DATAPHPExcel_CalcEngine_CyclicReferenceStack $stack) {
