...
/**
 * DATAPHPExcel_CachedObjectStorageFactory
 *
 * @category    DATAPHPExcel
 * @package        DATAPHPExcel_CachedObjectStorage
 * @copyright    Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_CachedObjectStorageFactory
{
     ...
     *
     * @return DATAPHPExcel_CachedObjectStorage_ICache|NULL
     **/
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = 'DATAPHPExcel_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = 'DATAPHPExcel_CachedObjectStorage_'.$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = 'DATAPHPExcel_CachedObjectStorage_' . $method;
     ...
     *
     * @param    DATAPHPExcel_Worksheet     $parent        Enable cell caching for this worksheet
     * @return    DATAPHPExcel_CachedObjectStorage_ICache
     **/
    public static function getInstance(DATAPHPExcel_Worksheet $parent)
    {
