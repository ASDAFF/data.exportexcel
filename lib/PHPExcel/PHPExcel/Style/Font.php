...
/**
 * DATAPHPExcel_Style_Font
 *
 * @category   DATAPHPExcel
 * @package	DATAPHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Style_Font extends DATAPHPExcel_Style_Supervisor implements DATAPHPExcel_IComparable
{
	/* Underline types */
	...
	/**
	 * Create a new DATAPHPExcel_Style_Font
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		if ($isConditional) {
			...
			$this->_color			= new DATAPHPExcel_Style_Color(DATAPHPExcel_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
		} else {
	 ...
	 *
	 * <code>
	 * $objDATAPHPExcel->getActiveSheet()->getStyle('B2')->getFont()->applyFromArray(
	 *		array(
	 *			'name'		=> 'Arial',
	 *			'bold'		=> TRUE,
	 *			'italic'	=> FALSE,
	 ...
	 * Set Underline
	 *
	 * @param string|boolean $pValue	DATAPHPExcel_Style_Font underline type
