...
/**
 * DATAPHPExcel_Style_Color
 *
 * @category   DATAPHPExcel
 * @package	DATAPHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Style_Color extends DATAPHPExcel_Style_Supervisor implements DATAPHPExcel_IComparable
{
	/* Colors */
	...
	/**
	 * Create a new DATAPHPExcel_Style_Color
	 *
	 ...
	 *										its ramifications are
	 */
	public function __construct($pARGB = DATAPHPExcel_Style_Color::COLOR_BLACK, $isSupervisor = FALSE, $isConditional = FALSE)
	{
		//	Supervisor?
	 ...
	 *
	 * <code>
	 * $objDATAPHPExcel->getActiveSheet()->getStyle('B2')->getFont()->getColor()->applyFromArray( array('rgb' => '808080') );
	 * </code>
	 *
	 ...
	 * @return DATAPHPExcel_Style_Color
	 */
	public function setARGB($pValue = DATAPHPExcel_Style_Color::COLOR_BLACK) {
		if ($pValue == '') {
			$pValue = DATAPHPExcel_Style_Color::COLOR_BLACK;
		}
		if ($this->_isSupervisor) {
	...
	public static function indexedColor($pIndex, $background=FALSE) {
		...
		if (array_key_exists($pIndex, self::$_indexedColors)) {
			return new DATAPHPExcel_Style_Color(self::$_indexedColors[$pIndex]);
		}

		if ($background) {
			return new DATAPHPExcel_Style_Color('FFFFFFFF');
		}
		return new DATAPHPExcel_Style_Color('FF000000');
	}
