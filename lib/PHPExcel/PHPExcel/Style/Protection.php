...
/**
 * DATAPHPExcel_Style_Protection
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Style_Protection extends DATAPHPExcel_Style_Supervisor implements DATAPHPExcel_IComparable
{
	/** Protection styles */
	...
	/**
     * Create a new DATAPHPExcel_Style_Protection
	 *
     ...
     *
     * <code>
     * $objDATAPHPExcel->getActiveSheet()->getStyle('B2')->getLocked()->applyFromArray(
     *		array(
     *			'locked' => TRUE,
     *			'hidden' => FALSE
     *		)
