...
/**
 * DATAPHPExcel_CachedObjectStorage_SQLite3
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_CachedObjectStorage_SQLite3 extends DATAPHPExcel_CachedObjectStorage_CacheBase implements DATAPHPExcel_CachedObjectStorage_ICache {
