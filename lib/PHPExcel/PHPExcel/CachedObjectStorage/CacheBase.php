...
/**
 * DATAPHPExcel_CachedObjectStorage_CacheBase
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
abstract class DATAPHPExcel_CachedObjectStorage_CacheBase {
	...
	public function __construct(DATAPHPExcel_Worksheet $parent) {
		...
		//	This is maintained within the cache controller to facilitate re-attaching it to DATAPHPExcel_Cell objects when
