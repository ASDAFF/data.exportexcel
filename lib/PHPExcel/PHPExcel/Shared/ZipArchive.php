 ...
 * @package    DATAPHPExcel_Shared_ZipArchive
...
if (!defined('PCLZIP_TEMPORARY_DIR')) {
	define('PCLZIP_TEMPORARY_DIR', DATAPHPExcel_Shared_File::sys_get_temp_dir());
}
require_once DATAPHPEXCEL_ROOT . 'DATAPHPExcel/Shared/PCLZip/pclzip.lib.php';


/**
 * DATAPHPExcel_Shared_ZipArchive
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Shared_ZipArchive
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Shared_ZipArchive
{
	...
	public function addFromString($localname, $contents)
	{
		...
		if ($res == 0) {
			throw new DATAPHPExcel_Writer_Exception("Error zipping files : " . $this->_zip->errorInfo(true));
		}
