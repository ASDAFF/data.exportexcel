 ...
 * wrapper, use DATAPHPExcel_Shared_OLE_PPS_File::getStream().
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Shared_OLE
 */
class DATAPHPExcel_Shared_OLE_ChainedBlockStream
{
	/**
	...
	public function stream_open($path, $mode, $options, &$openedPath)
	{
		...
		parse_str(cp_substr($path, 25), $this->params);
		...
		if (isset($this->params['size'])) {
			$this->data = cp_substr($this->data, 0, $this->params['size']);
		}
	...
	public function stream_read($count)
	{
		...
		$s = cp_substr($this->data, $this->pos, $count);
		$this->pos += $count;
		return $s;
	}
