...
*/
class DATAPHPExcel_Shared_OLE_PPS
{
	/**
	* The PPS index
	* @var integer
	...
	*/
	public function _getPpsWk()
	{
		...
		$ret .= pack("v", cp_strlen($this->Name) + 2)  // 66
			  . pack("c", $this->Type)              // 67
			  . pack("c", 0x00) //UK                // 68
			  ...
			  . "\x00\x00\x00\x00"                  // 100
			  . DATAPHPExcel_Shared_OLE::LocalDate2OLE($this->Time1st)       // 108
			  . DATAPHPExcel_Shared_OLE::LocalDate2OLE($this->Time2nd)       // 116
