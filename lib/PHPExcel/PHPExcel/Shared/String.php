...
/**
 * DATAPHPExcel_Shared_String
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Shared_String
{
	/**	Constants				*/
	/**	Regular Expressions		*/
	//	Fraction
	...
	public static function convertToNumberIfFraction(&$operand) {
		if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
			...
			$operand = DATAPHPExcel_Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
			return true;
		}
		return false;
	...
	/**
	 * Set the decimal separator. Only used by DATAPHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by DATAPHPExcel_Writer_HTML and DATAPHPExcel_Writer_PDF
	 *
	...
	/**
	 * Set the thousands separator. Only used by DATAPHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by DATAPHPExcel_Writer_HTML and DATAPHPExcel_Writer_PDF
	 *
	...
	/**
	 * Set the currency code. Only used by DATAPHPExcel_Style_NumberFormat::toFormattedString()
	 *		to format output by DATAPHPExcel_Writer_HTML and DATAPHPExcel_Writer_PDF
	 *
