...
/**
 * DATAPHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
{
	/**
	 ...
	 *
	 * @return DATAPHPExcel_Shared_Escher_DgContainer_SpgrContainer
	 */
	...
	public function getNestingLevel()
	{
		...
		while ($parent instanceof DATAPHPExcel_Shared_Escher_DgContainer_SpgrContainer) {
			++$nestingLevel;
