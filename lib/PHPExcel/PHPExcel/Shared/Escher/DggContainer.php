...
/**
 * DATAPHPExcel_Shared_Escher_DggContainer
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Shared_Escher_DggContainer
{
	/**
	 ...
	 *
	 * @return DATAPHPExcel_Shared_Escher_DggContainer_BstoreContainer
	 */
	 ...
	 *
	 * @param DATAPHPExcel_Shared_Escher_DggContainer_BstoreContainer $bstoreContainer
	 */
