...
require_once DATAPHPEXCEL_ROOT . 'DATAPHPExcel/Shared/trend/bestFitClass.php';
require_once DATAPHPEXCEL_ROOT . 'DATAPHPExcel/Shared/JAMA/Matrix.php';


/**
 * DATAPHPExcel_Polynomial_Best_Fit
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Shared_Trend
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Polynomial_Best_Fit extends DATAPHPExcel_Best_Fit
{
	/**
