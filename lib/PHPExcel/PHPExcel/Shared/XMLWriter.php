...
/**
 * DATAPHPExcel_Shared_XMLWriter
 *
 * @category   DATAPHPExcel
 * @package	DATAPHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Shared_XMLWriter extends XMLWriter {
	...
	/**
	 * Create a new DATAPHPExcel_Shared_XMLWriter instance
	 *
	...
	public function __construct($pTemporaryStorage = self::STORAGE_MEMORY, $pTemporaryStorageFolder = NULL) {
		...
		if ($pTemporaryStorage == self::STORAGE_MEMORY) {
			...
			if ($pTemporaryStorageFolder === NULL)
				$pTemporaryStorageFolder = DATAPHPExcel_Shared_File::sys_get_temp_dir();
