...
$pdfRendererClassFile = DATAPHPExcel_Settings::getPdfRendererPath() . '/mpdf.php';
...
/**
 *  DATAPHPExcel_Writer_PDF_mPDF
 *
 *  @category    DATAPHPExcel
 *  @package     DATAPHPExcel_Writer_PDF
 *  @copyright   Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Writer_PDF_mPDF extends DATAPHPExcel_Writer_PDF_Core implements DATAPHPExcel_Writer_IWriter
{
    /**
