...
/**
 * DATAPHPExcel_Writer_Excel2007
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Writer_2007
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Writer_Excel2007 extends DATAPHPExcel_Writer_Abstract implements DATAPHPExcel_Writer_IWriter
{
	/**
	 ...
	 *
	 * @var DATAPHPExcel_Writer_Excel2007_WriterPart[]
	 */
	private $_writerParts	= array();

	/**
	 * Private DATAPHPExcel
	 *
	 * @var DATAPHPExcel
	 */
	...
	/**
	 * Private unique DATAPHPExcel_Style_Conditional HashTable
	 *
	 * @var DATAPHPExcel_HashTable
	 */
	private $_stylesConditionalHashTable;

	/**
	 * Private unique DATAPHPExcel_Style_Fill HashTable
	 *
	 * @var DATAPHPExcel_HashTable
	 */
	...
	/**
	 * Private unique DATAPHPExcel_Style_Font HashTable
	 *
	 * @var DATAPHPExcel_HashTable
	 */
	...
	/**
	 * Private unique DATAPHPExcel_Style_Borders HashTable
	 *
	 * @var DATAPHPExcel_HashTable
	 */
	...
	/**
	 * Private unique DATAPHPExcel_Style_NumberFormat HashTable
	 *
	 * @var DATAPHPExcel_HashTable
	 */
	...
	/**
	 * Private unique DATAPHPExcel_Worksheet_BaseDrawing HashTable
	 *
	 * @var DATAPHPExcel_HashTable
	 */
    ...
    /**
     * Create a new DATAPHPExcel_Writer_Excel2007
     *
	 * @param 	DATAPHPExcel	$pDATAPHPExcel
     */
    public function __construct(DATAPHPExcel $pDATAPHPExcel = null)
    {
    	// Assign DATAPHPExcel
		$this->setDATAPHPExcel($pDATAPHPExcel);

    	$writerPartsArray = array(	'stringtable'	=> 'DATAPHPExcel_Writer_Excel2007_StringTable',
									'contenttypes'	=> 'DATAPHPExcel_Writer_Excel2007_ContentTypes',
									'docprops' 		=> 'DATAPHPExcel_Writer_Excel2007_DocProps',
									'rels'			=> 'DATAPHPExcel_Writer_Excel2007_Rels',
									'theme' 		=> 'DATAPHPExcel_Writer_Excel2007_Theme',
									'style' 		=> 'DATAPHPExcel_Writer_Excel2007_Style',
									'workbook' 		=> 'DATAPHPExcel_Writer_Excel2007_Workbook',
									'worksheet' 	=> 'DATAPHPExcel_Writer_Excel2007_Worksheet',
									'drawing' 		=> 'DATAPHPExcel_Writer_Excel2007_Drawing',
									'comments' 		=> 'DATAPHPExcel_Writer_Excel2007_Comments',
									'chart'			=> 'DATAPHPExcel_Writer_Excel2007_Chart',
								 );
		...
		foreach ($hashTablesArray as $tableName) {
			$this->$tableName 	= new DATAPHPExcel_HashTable();
		}
    }
	 ...
	 * @return 	DATAPHPExcel_Writer_Excel2007_WriterPart
	 */
	...
	public function save($pFilename = null)
	{
		if ($this->_spreadSheet !== NULL) {
			...
			if (strtolower($pFilename) == 'php://output' || strtolower($pFilename) == 'php://stdout') {
				$pFilename = @tempnam(DATAPHPExcel_Shared_File::sys_get_temp_dir(), 'phpxltmp');
				if ($pFilename == '') {
					$pFilename = $originalFilename;
				}
			}

			$saveDebugLog = DATAPHPExcel_Calculation::getInstance($this->_spreadSheet)->getDebugLog()->getWriteDebugLog();
			DATAPHPExcel_Calculation::getInstance($this->_spreadSheet)->getDebugLog()->setWriteDebugLog(FALSE);
			$saveDateReturnType = DATAPHPExcel_Calculation_Functions::getReturnDateType();
			...
			$zipClass = DATAPHPExcel_Settings::getZipClass();
			$objZip = new $zipClass();
			...
			if ($objZip->open($pFilename, $zipOverWrite) !== true) {
				if ($objZip->open($pFilename, $zipCreate) !== true) {
					throw new DATAPHPExcel_Writer_Exception("Could not open " . $pFilename . " for writing.");
				}
			}
			...
			for ($i = 0; $i < $this->getDrawingHashTable()->count(); ++$i) {
				if ($this->getDrawingHashTable()->getByIndex($i) instanceof DATAPHPExcel_Worksheet_Drawing) {
					$imageContents = null;
				...
				} else if ($this->getDrawingHashTable()->getByIndex($i) instanceof DATAPHPExcel_Worksheet_MemoryDrawing) {
					ob_start();
					call_user_func(
			...
			DATAPHPExcel_Calculation_Functions::setReturnDateType($saveDateReturnType);
			DATAPHPExcel_Calculation::getInstance($this->_spreadSheet)->getDebugLog()->setWriteDebugLog($saveDebugLog);

			// Close file
			if ($objZip->close() === false) {
				throw new DATAPHPExcel_Writer_Exception("Could not close zip file $pFilename.");
			}

			// If a temporary file was used, copy it to the correct file stream
			if ($originalFilename != $pFilename) {
				if (copy($pFilename, $originalFilename) === false) {
					throw new DATAPHPExcel_Writer_Exception("Could not copy temporary zip file $pFilename to $originalFilename.");
				}
				@unlink($pFilename);
			}
		} else {
			throw new DATAPHPExcel_Writer_Exception("DATAPHPExcel object unassigned.");
		}
	}

	/**
	 * Get DATAPHPExcel object
	 *
	 * @return DATAPHPExcel
	 * @throws DATAPHPExcel_Writer_Exception
	 */
	public function getDATAPHPExcel() {
		if ($this->_spreadSheet !== null) {
			return $this->_spreadSheet;
		} else {
			throw new DATAPHPExcel_Writer_Exception("No DATAPHPExcel assigned.");
		}
	}

	/**
	 * Set DATAPHPExcel object
	 *
	 * @param 	DATAPHPExcel 	$pDATAPHPExcel	DATAPHPExcel object
	 * @throws	DATAPHPExcel_Writer_Exception
	 * @return DATAPHPExcel_Writer_Excel2007
	 */
	public function setDATAPHPExcel(DATAPHPExcel $pDATAPHPExcel = null) {
		$this->_spreadSheet = $pDATAPHPExcel;
		return $this;
	}
    ...
    /**
     * Get DATAPHPExcel_Style_Conditional HashTable
     *
     * @return DATAPHPExcel_HashTable
     */
    ...
    /**
     * Get DATAPHPExcel_Style_Fill HashTable
     *
     * @return DATAPHPExcel_HashTable
     */
    ...
    /**
     * Get DATAPHPExcel_Style_Font HashTable
     *
     * @return DATAPHPExcel_HashTable
     */
    ...
    /**
     * Get DATAPHPExcel_Style_Borders HashTable
     *
     * @return DATAPHPExcel_HashTable
     */
    ...
    /**
     * Get DATAPHPExcel_Style_NumberFormat HashTable
     *
     * @return DATAPHPExcel_HashTable
     */
    ...
    /**
     * Get DATAPHPExcel_Worksheet_BaseDrawing HashTable
     *
     * @return DATAPHPExcel_HashTable
     */
