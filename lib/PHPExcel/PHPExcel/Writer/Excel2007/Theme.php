...
/**
 * DATAPHPExcel_Writer_Excel2007_Theme
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Writer_Excel2007_Theme extends DATAPHPExcel_Writer_Excel2007_WriterPart
{
	/**
	 ...
	 */
	public function writeTheme(DATAPHPExcel $pDATAPHPExcel = null)
	{
			// Create XML writer
			$objWriter = null;
	 ...
	 *
	 * @param 	DATAPHPExcel_Shared_XMLWriter	$objWriter
