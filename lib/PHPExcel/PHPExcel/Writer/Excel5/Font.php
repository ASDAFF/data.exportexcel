...
/**
 * DATAPHPExcel_Writer_Excel5_Font
 *
 * @category   DATAPHPExcel
 * @package    DATAPHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Writer_Excel5_Font
{
	/**
	 * Color index
	 *
	 ...
	 */
	public function __construct(DATAPHPExcel_Style_Font $font = null)
	{
	...
	public function writeFont()
	{
		...
		$bCharSet = DATAPHPExcel_Shared_Font::getCharsetFromFontName($this->_font->getName()); // Character set
		...
		$data .= DATAPHPExcel_Shared_String::UTF8toBIFF8UnicodeShort($this->_font->getName());
	 ...
	 *
	 */
	private static $_mapUnderline = array(	DATAPHPExcel_Style_Font::UNDERLINE_NONE					=> 0x00,
											DATAPHPExcel_Style_Font::UNDERLINE_SINGLE				=> 0x01,
											DATAPHPExcel_Style_Font::UNDERLINE_DOUBLE				=> 0x02,
											DATAPHPExcel_Style_Font::UNDERLINE_SINGLEACCOUNTING		=> 0x21,
											DATAPHPExcel_Style_Font::UNDERLINE_DOUBLEACCOUNTING		=> 0x22,
										 );
	/**
	 * Map underline
	 *
