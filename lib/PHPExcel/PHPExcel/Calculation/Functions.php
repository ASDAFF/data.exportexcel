...
/**
 * DATAPHPExcel_Calculation_Functions
 *
 * @category	DATAPHPExcel
 * @package		DATAPHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Calculation_Functions {
	 ...
	 *													DATAPHPExcel_Calculation_Functions::COMPATIBILITY_EXCEL			'Excel'
	 *													DATAPHPExcel_Calculation_Functions::COMPATIBILITY_GNUMERIC		'Gnumeric'
	 *													DATAPHPExcel_Calculation_Functions::COMPATIBILITY_OPENOFFICE	'OpenOfficeCalc'
	 ...
	 *												Permitted values are:
	 *													DATAPHPExcel_Calculation_Functions::RETURNDATE_PHP_NUMERIC		'P'
	 *													DATAPHPExcel_Calculation_Functions::RETURNDATE_PHP_OBJECT		'O'
	 *													DATAPHPExcel_Calculation_Functions::RETURNDATE_EXCEL			'E'
	 * @return	 boolean							Success or failure
	 */
	...
	public static function _ifCondition($condition) {
		$condition	= DATAPHPExcel_Calculation_Functions::flattenSingleValue($condition);
		if (!isset($condition{0}))
			$condition = '=""';
		if (!in_array($condition{0},array('>', '<', '='))) {
			if (!is_numeric($condition)) { $condition = DATAPHPExcel_Calculation::_wrapResult(strtoupper($condition)); }
			return '='.$condition;
		} else {
			preg_match('/([<>=]+)(.*)/',$condition,$matches);
			list(,$operator,$operand) = $matches;
			if (!is_numeric($operand)) { $operand = DATAPHPExcel_Calculation::_wrapResult(strtoupper($operand)); }
	...
	public static function VERSION() {
		return 'DATAPHPExcel 1.7.9, 2013-06-02';
	}	//	function VERSION()
