...
/**
 * DATAPHPExcel_Calculation_Token_Stack
 *
 * @category	DATAPHPExcel_Calculation_Token_Stack
 * @package		DATAPHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Calculation_Token_Stack {
	...
	public function push($type, $value, $reference = NULL) {
		...
		if ($type == 'Function') {
			$localeFunction = DATAPHPExcel_Calculation::_localeFunc($value);
