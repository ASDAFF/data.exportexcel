 ...
 * @copyright  Copyright (c) 2006 - 2013 DATAPHPExcel (http://www.codeplex.com/DATAPHPExcel)
 */
class DATAPHPExcel_Style extends DATAPHPExcel_Style_Supervisor implements DATAPHPExcel_IComparable
{
    /**
     * Font
     *
     ...
     * Borders
     *
     * @var DATAPHPExcel_Style_Borders
     */
    protected $_borders;
     ...
     * Alignment
     *
     * @var DATAPHPExcel_Style_Alignment
     */
     ...
     * Number Format
     *
     * @var DATAPHPExcel_Style_NumberFormat
     */
     ...
     * Conditional styles
     *
     * @var DATAPHPExcel_Style_Conditional[]
     */
     ...
     * Protection
     *
     * @var DATAPHPExcel_Style_Protection
     */
    ...
    /**
     * Create a new DATAPHPExcel_Style
     *
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        $this->_font              = new DATAPHPExcel_Style_Font($isSupervisor, $isConditional);
        $this->_fill              = new DATAPHPExcel_Style_Fill($isSupervisor, $isConditional);
        $this->_borders           = new DATAPHPExcel_Style_Borders($isSupervisor, $isConditional);
        $this->_alignment         = new DATAPHPExcel_Style_Alignment($isSupervisor, $isConditional);
        $this->_numberFormat      = new DATAPHPExcel_Style_NumberFormat($isSupervisor, $isConditional);
        $this->_protection        = new DATAPHPExcel_Style_Protection($isSupervisor, $isConditional);
     ...
     *
     * <code>
     * $objDATAPHPExcel->getActiveSheet()->getStyle('B2')->applyFromArray(
     *         array(
     *             'font'    => array(
     *                 'name'      => 'Arial',
     *                 'bold'      => true,
     *                 'italic'    => false,
     *                 'underline' => DATAPHPExcel_Style_Font::UNDERLINE_DOUBLE,
     *                 'strike'    => false,
     *                 'color'     => array(
     *                     'rgb' => '808080'
     *                 )
            ...
            if ($this->_isSupervisor) {
                ...
                if ($pAdvanced && isset($pStyles['borders'])) {
                    ...
                    for ($x = 1; $x <= $xMax; ++$x) {
                        ...
                        $colStart = ($x == 3) ?
                            DATAPHPExcel_Cell::stringFromColumnIndex($rangeEnd[0])
                                : DATAPHPExcel_Cell::stringFromColumnIndex($rangeStart[0] + $x - 1);

                        // end column index for region
                        $colEnd = ($x == 1) ?
                            DATAPHPExcel_Cell::stringFromColumnIndex($rangeStart[0])
                                : DATAPHPExcel_Cell::stringFromColumnIndex($rangeEnd[0] - $xMax + $x);
     ...
     * Get Fill
     *
     * @return DATAPHPExcel_Style_Fill
     */
     ...
     * @return DATAPHPExcel_Style
     */
    public function setFont(DATAPHPExcel_Style_Font $font)
    {
        $this->_font = $font;
        return $this;
    }
     ...
     * Get Number Format
     *
     * @return DATAPHPExcel_Style_NumberFormat
     */
     ...
     *
     * @param DATAPHPExcel_Style_Conditional[] $pValue Array of condtional styles
     * @return DATAPHPExcel_Style
     */
     ...
     * Get Protection
     *
     * @return DATAPHPExcel_Style_Protection
     */
