...
class DATAPHPExcel_Chart
{
	 ...
	 * Chart Plot Area
	 *
	 * @var DATAPHPExcel_Chart_PlotArea
	 */
	...
	/**
	 * Create a new DATAPHPExcel_Chart
	 */
	public function __construct($name, DATAPHPExcel_Chart_Title $title = null, DATAPHPExcel_Chart_Legend $legend = null, DATAPHPExcel_Chart_PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', DATAPHPExcel_Chart_Title $xAxisLabel = null, DATAPHPExcel_Chart_Title $yAxisLabel = null)
	{
		$this->_name = $name;
		$this->_title = $title;
		$this->_legend = $legend;
	 ...
	 * Set Worksheet
	 *
	 * @param	DATAPHPExcel_Worksheet	$pValue
	 * @throws	DATAPHPExcel_Chart_Exception
	 * @return DATAPHPExcel_Chart
	 */
	public function setWorksheet(DATAPHPExcel_Worksheet $pValue = null) {
	 ...
	 * Get Title
	 *
	 * @return DATAPHPExcel_Chart_Title
	 */
	 ...
	 * @return	DATAPHPExcel_Chart
	 */
	public function setTitle(DATAPHPExcel_Chart_Title $title) {
		$this->_title = $title;
	 ...
	 * Get Legend
	 *
	 * @return DATAPHPExcel_Chart_Legend
	 */
	 ...
	 * @return	DATAPHPExcel_Chart
	 */
	public function setLegend(DATAPHPExcel_Chart_Legend $legend) {
		$this->_legend = $legend;
	 ...
	 * Set X-Axis Label
	 *
	 * @param	DATAPHPExcel_Chart_Title $label
	 * @return	DATAPHPExcel_Chart
	 */
	public function setXAxisLabel(DATAPHPExcel_Chart_Title $label) {
	 ...
	 * @return	DATAPHPExcel_Chart
	 */
	public function setYAxisLabel(DATAPHPExcel_Chart_Title $label) {
	 ...
	 * Get Plot Area
	 *
	 * @return DATAPHPExcel_Chart_PlotArea
	 */
	...
	public function render($outputDestination = null) {
		$libraryName = DATAPHPExcel_Settings::getChartRendererName();
		...
		$libraryPath = DATAPHPExcel_Settings::getChartRendererPath();
		...
		$rendererName = 'DATAPHPExcel_Chart_Renderer_'.$libraryName;
