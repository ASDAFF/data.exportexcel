...
class CDATAExportGlobalCondCtrl
{
			...
			if (!$boolValueError)
			{
				...
				switch ($arControl['FIELD_TYPE'])
				{
					...
					case 'datetime':
						...
						$boolValueError = CDATAExportGlobalCondCtrl::ConvertInt2DateTime($arOneCondition['value'], $strFormat, $intOffset);
						break;
					default:
						$boolValueError = true;
						break;
			...
			if (!$boolError)
			{
				...
				switch ($arControl['FIELD_TYPE'])
				{
					...
					case 'datetime':
						...
						$boolError = CDATAExportGlobalCondCtrl::ConvertDateTime2Int($arOneCondition['value'], $strFormat, $intOffset);
						break;
					default:
						$boolError = true;
						break;
					...
					else
					{
						...
						switch ($arOneAtom['ATOM']['FIELD_TYPE'])
						{
							...
							case 'datetime':
								...
								$boolAtomError = CDATAExportGlobalCondCtrl::ConvertInt2DateTime($arOneCondition[$strID], $strFormat, $intOffset);
								break;
							default:
								$boolAtomError = true;
						}
					...
					if (!$boolAtomError)
					{
						switch ($arOneAtom['ATOM']['FIELD_TYPE'])
						{
							...
							case 'datetime':
								...
								$boolAtomError = CDATAExportGlobalCondCtrl::ConvertDateTime2Int($arOneCondition[$strName], $strFormat, $intOffset);
								break;
							default:
								$boolAtomError = true;
						}
...
class CDATAExportGlobalCondCtrlComplex extends CDATAExportGlobalCondCtrl
{
	public static function GetControlDescr()
	{
		$strClassName = get_called_class();
...
class CDATAExportGlobalCondCtrlGroup extends CDATAExportGlobalCondCtrl
{
	public static function GetControlDescr()
	{
		$strClassName = get_called_class();
...
class CDATAExportCatalogCondCtrl extends CDATAExportGlobalCondCtrl
{
}

class CDATAExportCatalogCondCtrlComplex extends CDATAExportGlobalCondCtrlComplex
{
}

class CDATAExportCatalogCondCtrlGroup extends CDATAExportGlobalCondCtrlGroup
{
}

class CDATAExportCatalogCondCtrlIBlockFields extends CDATAExportCatalogCondCtrlComplex
{
	/**
	 * @return string|array
	 */
...
class CDATAExportCatalogCondCtrlIBlockProps extends CDATAExportCatalogCondCtrlComplex
{
	/**
	 * @param bool|string $strControlID
	 * @return bool|array
...
class CDATAExportGlobalCondTree
{
	...
	public function OnConditionControlBuildList()
	{
		if (!$this->boolError && !isset($this->arControlList))
		{
			...
			$arMethods = array(
				array('CDATAExportCatalogCondCtrlGroup', 'GetControlDescr'),
				array('CDATAExportCatalogCondCtrlIBlockFields', 'GetControlDescr'),
				array('CDATAExportCatalogCondCtrlIBlockProps', 'GetControlDescr')
			);
			...
			{
				$arRes = call_user_func_array($method, array());
...
class CDATAExportCondTree extends CDATAExportGlobalCondTree
{
	public function __construct()
	{
