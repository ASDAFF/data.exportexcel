...
class CDATAExportUtils {
	...
	public static function ShowFilter($sTableID, $listIndex, $SETTINGS, $SETTINGS_DEFAULT)
	{
		...
		{
			$boolSKU = true;
			$strSKUName = Loc::getMessage('DATA_EE_IBLIST_A_OFFERS');
		...
		<?
		$arFindFields = Array();
		$arFindFields["IBEL_A_F_ID"] = Loc::getMessage("DATA_EE_IBEL_A_F_ID");
		$arFindFields["IBEL_A_F_PARENT"] = Loc::getMessage("DATA_EE_IBEL_A_F_PARENT");

		$arFindFields["IBEL_A_F_MODIFIED_WHEN"] = Loc::getMessage("DATA_EE_IBEL_A_F_MODIFIED_WHEN");
		$arFindFields["IBEL_A_F_MODIFIED_BY"] = Loc::getMessage("DATA_EE_IBEL_A_F_MODIFIED_BY");
		$arFindFields["IBEL_A_F_CREATED_WHEN"] = Loc::getMessage("DATA_EE_IBEL_A_F_CREATED_WHEN");
		$arFindFields["IBEL_A_F_CREATED_BY"] = Loc::getMessage("DATA_EE_IBEL_A_F_CREATED_BY");

		$arFindFields["IBEL_A_F_ACTIVE_FROM"] = Loc::getMessage("DATA_EE_IBEL_A_ACTFROM");
		$arFindFields["IBEL_A_F_ACTIVE_TO"] = Loc::getMessage("DATA_EE_IBEL_A_ACTTO");
		$arFindFields["IBEL_A_F_ACT"] = Loc::getMessage("DATA_EE_IBEL_A_F_ACT");
		$arFindFields["IBEL_A_F_SORT"] = Loc::getMessage("DATA_EE_IBEL_A_F_SORT");
		$arFindFields["IBEL_A_F_NAME"] = Loc::getMessage("DATA_EE_IBEL_A_F_NAME");
		$arFindFields["IBEL_A_F_PREDESC"] = Loc::getMessage("DATA_EE_IBEL_A_F_PREDESC");
		$arFindFields["IBEL_A_F_DESC"] = Loc::getMessage("DATA_EE_IBEL_A_F_DESC");
		$arFindFields["IBEL_A_CODE"] = Loc::getMessage("DATA_EE_IBEL_A_CODE");
		$arFindFields["IBEL_A_EXTERNAL_ID"] = Loc::getMessage("DATA_EE_IBEL_A_EXTERNAL_ID");
		$arFindFields["IBEL_A_PREVIEW_PICTURE"] = Loc::getMessage("DATA_EE_IBEL_A_PREVIEW_PICTURE");
		$arFindFields["IBEL_A_DETAIL_PICTURE"] = Loc::getMessage("DATA_EE_IBEL_A_DETAIL_PICTURE");
		$arFindFields["IBEL_A_TAGS"] = Loc::getMessage("DATA_EE_IBEL_A_TAGS");
		
		if ($bCatalog)
		{
			if(is_array($productTypeList)) $arFindFields["CATALOG_TYPE"] = Loc::getMessage("DATA_EE_CATALOG_TYPE");
			$arFindFields["CATALOG_BUNDLE"] = Loc::getMessage("DATA_EE_CATALOG_BUNDLE");
			$arFindFields["CATALOG_AVAILABLE"] = Loc::getMessage("DATA_EE_CATALOG_AVAILABLE");
			$arFindFields["CATALOG_QUANTITY"] = Loc::getMessage("DATA_EE_CATALOG_QUANTITY");
			if(is_array($arStores))
			{
				foreach($arStores as $arStore)
				{
					$arFindFields["CATALOG_STORE".$arStore['ID']."_QUANTITY"] = sprintf(Loc::getMessage("DATA_EE_CATALOG_STORE_QUANTITY"), $arStore['TITLE']);
				}
				if(count($arStores) > 0) $arFindFields["CATALOG_STORE_ANY_QUANTITY"] = Loc::getMessage("DATA_EE_CATALOG_STORE_ANY_QUANTITY");
			}
			$arFindFields["CATALOG_PURCHASING_PRICE"] = Loc::getMessage("DATA_EE_CATALOG_PURCHASING_PRICE");
			if(is_array($arPrices))
			{
				foreach($arPrices as $arPrice)
				{
					$arFindFields["CATALOG_PRICE_".$arPrice['ID']] = sprintf(Loc::getMessage("DATA_EE_CATALOG_PRICE"), $arPrice['NAME_LANG']);
				}
			}
			
			if($bSale)
			{
				$arFindFields["SALE_ORDER"] = Loc::getMessage("DATA_EE_EL_A_SALE_ORDER");
			}
		}
		...
		if($boolSKU)
		{
			$arFindFields["IBEL_A_SUB_F_ID"] = ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_IBEL_A_F_ID");
			$arFindFields["IBEL_A_SUB_F_MODIFIED_WHEN"] = ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_IBEL_A_F_MODIFIED_WHEN");
			$arFindFields["IBEL_A_SUB_F_ACT"] = ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_IBEL_A_F_ACT");
			$arFindFields["IBEL_A_SUB_F_SORT"] = ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_IBEL_A_F_SORT");
			if(1 || $bCatalog)
			{
				$arFindFields["SUB_CATALOG_QUANTITY"] = ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_CATALOG_QUANTITY");
				if(is_array($arStores))
				{
					foreach($arStores as $arStore)
					{
						$arFindFields["SUB_CATALOG_STORE".$arStore['ID']."_QUANTITY"] = ('' != $strSKUName ? $strSKUName.' - ' : '').sprintf(Loc::getMessage("DATA_EE_CATALOG_STORE_QUANTITY"), $arStore['TITLE']);
					}
					if(count($arStores) > 0) $arFindFields["SUB_CATALOG_STORE_ANY_QUANTITY"] = ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_CATALOG_STORE_ANY_QUANTITY");
				}
				$arFindFields["SUB_CATALOG_PURCHASING_PRICE"] = ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_CATALOG_PURCHASING_PRICE");
				if(is_array($arPrices))
				{
					foreach($arPrices as $arPrice)
					{
						$arFindFields["SUB_CATALOG_PRICE_".$arPrice['ID']] = ('' != $strSKUName ? $strSKUName.' - ' : '').sprintf(Loc::getMessage("DATA_EE_CATALOG_PRICE"), $arPrice['NAME_LANG']);
					}
				}
			}
		...
		?>
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_FILTER_FROMTO_ID")?>:</td>
				<td nowrap>
			...
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_FIELD_SECTION_ID")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_section_section][]" multiple size="5">
						<option value="-1"><?echo Loc::getMessage("DATA_EE_VALUE_ANY")?></option>
						<option value="0"<?if((is_array($arFields['find_section_section']) && in_array("0", $arFields['find_section_section'])) || $arFields['find_section_section']=="0")echo" selected"?>><?echo Loc::getMessage("DATA_EE_UPPER_LEVEL")?></option>
						<?
					...
					<input type="checkbox" name="SETTINGS[FILTER][<?=$listIndex?>][find_el_subsections]" value="Y"<?if($arFields['find_el_subsections']=="Y")echo" checked"?>> <?echo Loc::getMessage("DATA_EE_INCLUDING_SUBSECTIONS")?>
				</td>
			</tr>
			...
			?>
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_FIELD_TIMESTAMP_X")?>:</td>
			...
			<tr>
				<td><?=Loc::getMessage("DATA_EE_FIELD_MODIFIED_BY")?>:</td>
				<td>
					<?echo FindUserID(
			...
			?>
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_EL_ADMIN_DCREATE")?>:</td>
			...
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_EL_ADMIN_WCREATE")?></td>
				<td>
					<?echo FindUserID(
			...
			<tr class="data-ee-filter-date-wrap">
				<td><?echo Loc::getMessage("DATA_EE_EL_A_ACTFROM")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_vtype_active_from]"><option value=""><?echo Loc::getMessage("DATA_EE_IS_VALUE_FROM_TO")?></option><option value="empty"<?if($arFields['find_el_vtype_active_from']=='empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_EMPTY")?></option><option value="not_empty"<?if($arFields['find_el_vtype_active_from']=='not_empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_NOT_EMPTY")?></option></select></select>
			...
			<tr class="data-ee-filter-date-wrap">
				<td><?echo Loc::getMessage("DATA_EE_EL_A_ACTTO")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_vtype_date_active_to]"><option value=""><?echo Loc::getMessage("DATA_EE_IS_VALUE_FROM_TO")?></option><option value="empty"<?if($arFields['find_el_vtype_date_active_to']=='empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_EMPTY")?></option><option value="not_empty"<?if($arFields['find_el_vtype_date_active_to']=='not_empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_NOT_EMPTY")?></option></select></select>
			...
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_FIELD_ACTIVE")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_active]">
						<option value=""><?=htmlspecialcharsex(Loc::getMessage('DATA_EE_VALUE_ANY'))?></option>
						<option value="Y"<?if($arFields['find_el_active']=="Y")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_YES"))?></option>
						<option value="N"<?if($arFields['find_el_active']=="N")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_NO"))?></option>
					</select>
				</td>
			</tr>
			
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_FIELD_SORT")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_sort_comp]">
						<option value="eq" <?if($arFields['find_el_sort_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
						<option value="gt" <?if($arFields['find_el_sort_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
						<option value="geq" <?if($arFields['find_el_sort_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
						<option value="lt" <?if($arFields['find_el_sort_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
						<option value="leq" <?if($arFields['find_el_sort_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
					</select>
			...
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_FIELD_NAME")?>:</td>
			...
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_EL_ADMIN_PREDESC")?></td>
				<td><select class="data-ee-filter-chval" name="SETTINGS[FILTER][<?=$listIndex?>][find_el_vtype_pretext]"><option value=""><?echo Loc::getMessage("DATA_EE_IS_VALUE")?></option><option value="empty"<?if($arFields['find_el_vtype_pretext']=='empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_EMPTY")?></option><option value="not_empty"<?if($arFields['find_el_vtype_pretext']=='not_empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_NOT_EMPTY")?></option></select><input type="text" name="SETTINGS[FILTER][<?=$listIndex?>][find_el_pretext]" value="<?echo htmlspecialcharsex($arFields['find_el_pretext'])?>" size="30">&nbsp;<?=ShowFilterLogicHelp()?></td>
			</tr>
			<tr>
				<td><?echo Loc::getMessage("DATA_EE_EL_ADMIN_DESC")?></td>
				<td><select class="data-ee-filter-chval" name="SETTINGS[FILTER][<?=$listIndex?>][find_el_vtype_intext]"><option value=""><?echo Loc::getMessage("DATA_EE_IS_VALUE")?></option><option value="empty"<?if($arFields['find_el_vtype_intext']=='empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_EMPTY")?></option><option value="not_empty"<?if($arFields['find_el_vtype_intext']=='not_empty'){echo ' selected';}?>><?echo Loc::getMessage("DATA_EE_IS_NOT_EMPTY")?></option></select><input type="text" name="SETTINGS[FILTER][<?=$listIndex?>][find_el_intext]" value="<?echo htmlspecialcharsex($arFields['find_el_intext'])?>" size="30">&nbsp;<?=ShowFilterLogicHelp()?></td>
			</tr>

			<tr>
				<td><?=Loc::getMessage("DATA_EE_EL_A_CODE")?>:</td>
			...
			<tr>
				<td><?=Loc::getMessage("DATA_EE_EL_A_EXTERNAL_ID")?>:</td>
			...
			<tr>
				<td><?=Loc::getMessage("DATA_EE_EL_A_PREVIEW_PICTURE")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_preview_picture]">
						<option value=""><?=htmlspecialcharsex(Loc::getMessage('DATA_EE_VALUE_ANY'))?></option>
						<option value="Y"<?if($arFields['find_el_preview_picture']=="Y")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_IS_NOT_EMPTY"))?></option>
						<option value="N"<?if($arFields['find_el_preview_picture']=="N")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_IS_EMPTY"))?></option>
					</select>
				</td>
			</tr>
			<tr>
				<td><?=Loc::getMessage("DATA_EE_EL_A_DETAIL_PICTURE")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_detail_picture]">
						<option value=""><?=htmlspecialcharsex(Loc::getMessage('DATA_EE_VALUE_ANY'))?></option>
						<option value="Y"<?if($arFields['find_el_detail_picture']=="Y")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_IS_NOT_EMPTY"))?></option>
						<option value="N"<?if($arFields['find_el_detail_picture']=="N")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_IS_EMPTY"))?></option>
					</select>
				</td>
			</tr>
			<tr>
				<td><?=Loc::getMessage("DATA_EE_EL_A_TAGS")?>:</td>
				<td>
			...
			if ($bCatalog)
			{
				...
				{
				?><tr>
					<td><?=Loc::getMessage("DATA_EE_CATALOG_TYPE"); ?>:</td>
					<td>
				...
				?>
				<tr>
					<td><?echo Loc::getMessage("DATA_EE_CATALOG_BUNDLE")?>:</td>
					<td>
						<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_catalog_bundle]">
							<option value=""><?=htmlspecialcharsex(Loc::getMessage('DATA_EE_VALUE_ANY'))?></option>
							<option value="Y"<?if($arFields['find_el_catalog_bundle']=="Y")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_YES"))?></option>
							<option value="N"<?if($arFields['find_el_catalog_bundle']=="N")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_NO"))?></option>
						</select>
					</td>
				</tr>
				<tr>
					<td><?echo Loc::getMessage("DATA_EE_CATALOG_AVAILABLE")?>:</td>
					<td>
						<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_catalog_available]">
							<option value=""><?=htmlspecialcharsex(Loc::getMessage('DATA_EE_VALUE_ANY'))?></option>
							<option value="Y"<?if($arFields['find_el_catalog_available']=="Y")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_YES"))?></option>
							<option value="N"<?if($arFields['find_el_catalog_available']=="N")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_NO"))?></option>
						</select>
					</td>
				</tr>
				<tr>
					<td><?echo Loc::getMessage("DATA_EE_CATALOG_QUANTITY")?>:</td>
					<td>
						<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_catalog_quantity_comp]">
							<option value="eq" <?if($arFields['find_el_catalog_quantity_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
							<option value="gt" <?if($arFields['find_el_catalog_quantity_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
							<option value="geq" <?if($arFields['find_el_catalog_quantity_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
							<option value="lt" <?if($arFields['find_el_catalog_quantity_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
							<option value="leq" <?if($arFields['find_el_catalog_quantity_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
						</select>
				...
				if(is_array($arStores))
				{
					foreach($arStores as $arStore)
					{
						?>
						<tr>
							<td><?echo sprintf(Loc::getMessage("DATA_EE_CATALOG_STORE_QUANTITY"), $arStore['TITLE'])?>:</td>
							<td>
								<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_catalog_store<?echo $arStore['ID'];?>_quantity_comp]">
									<option value="eq" <?if($arFields['find_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
									<option value="gt" <?if($arFields['find_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
									<option value="geq" <?if($arFields['find_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
									<option value="lt" <?if($arFields['find_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
									<option value="leq" <?if($arFields['find_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
								</select>
					...
					?>
						<tr>
							<td><?echo Loc::getMessage("DATA_EE_CATALOG_STORE_ANY_QUANTITY")?>:</td>
							<td>
								...
								<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_catalog_store_any_quantity_comp]">
									<option value="eq" <?if($arFields['find_el_catalog_store_any_quantity_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
									<option value="gt" <?if($arFields['find_el_catalog_store_any_quantity_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
									<option value="geq" <?if($arFields['find_el_catalog_store_any_quantity_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
									<option value="lt" <?if($arFields['find_el_catalog_store_any_quantity_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
									<option value="leq" <?if($arFields['find_el_catalog_store_any_quantity_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
								</select>
				...
				?>
				<tr>
					<td><?echo Loc::getMessage("DATA_EE_CATALOG_PURCHASING_PRICE")?>:</td>
					<td>
						<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_catalog_purchasing_price_comp]">
							<option value="eq" <?if($arFields['find_el_catalog_purchasing_price_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
							<option value="gt" <?if($arFields['find_el_catalog_purchasing_price_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
							<option value="geq" <?if($arFields['find_el_catalog_purchasing_price_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
							<option value="lt" <?if($arFields['find_el_catalog_purchasing_price_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
							<option value="leq" <?if($arFields['find_el_catalog_purchasing_price_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
							<option value="from_to" <?if($arFields['find_el_catalog_purchasing_price_comp']=='from_to'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_FROM_TO')?></option>
						</select>
				...
				if(is_array($arPrices))
				{
					foreach($arPrices as $arPrice)
					{
						?>
						<tr>
							<td><?echo sprintf(Loc::getMessage("DATA_EE_CATALOG_PRICE"), $arPrice['NAME_LANG'])?>:</td>
							<td>
								<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_catalog_price_<?echo $arPrice['ID'];?>_comp]">
									<option value="eq" <?if($arFields['find_el_catalog_price_'.$arPrice['ID'].'_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
									<option value="empty" <?if($arFields['find_el_catalog_price_'.$arPrice['ID'].'_comp']=='empty'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EMPTY')?></option>
									<option value="gt" <?if($arFields['find_el_catalog_price_'.$arPrice['ID'].'_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
									<option value="geq" <?if($arFields['find_el_catalog_price_'.$arPrice['ID'].'_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
									<option value="lt" <?if($arFields['find_el_catalog_price_'.$arPrice['ID'].'_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
									<option value="leq" <?if($arFields['find_el_catalog_price_'.$arPrice['ID'].'_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
									<option value="from_to" <?if($arFields['find_el_catalog_price_'.$arPrice['ID'].'_comp']=='from_to'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_FROM_TO')?></option>
								</select>
				...
				if($bSale)
				{
					?>
					<tr>
						<td><?=Loc::getMessage("DATA_EE_EL_A_SALE_ORDER")?>:</td>
						<td>
			...
			<td>
				...
				elseif($arProp["PROPERTY_TYPE"]=='S'):?>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_property_<?=$arProp["ID"]?>_comp]">
						<option value="eq" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
						<option value="neq" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='neq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_NEQ')?></option>
						<option value="contain" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='contain'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_CONTAIN')?></option>
						<option value="not_contain" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='not_contain'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_NOT_CONTAIN')?></option>
						<option value="empty" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='empty'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_IS_EMPTY')?></option>
						<option value="not_empty" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='not_empty'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_IS_NOT_EMPTY')?></option>
						<option value="logical" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='logical'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LOGICAL')?></option>
					</select>
				...
				<?elseif($arProp["PROPERTY_TYPE"]=='N'):?>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_property_<?=$arProp["ID"]?>_comp]">
						<option value="eq" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
						<option value="gt" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
						<option value="geq" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
						<option value="lt" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
						<option value="leq" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
						<option value="from_to" <?if($arFields['find_el_property_'.$arProp["ID"].'_comp']=='from_to'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_FROM_TO')?></option>
					</select>
				...
				<?elseif($arProp["PROPERTY_TYPE"]=='L'):?>
					...
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_property_<?=$arProp["ID"]?>][]" multiple size="5">
						<option value=""><?echo Loc::getMessage("DATA_EE_VALUE_ANY")?></option>
						<option value="NOT_REF"<?if(in_array("NOT_REF", $propVal))echo " selected"?>><?echo Loc::getMessage("DATA_EE_ELEMENT_EDIT_NOT_SET")?></option><?
				...
				?>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_el_property_<?=$arProp["ID"]?>]">
						<option value=""><?=htmlspecialcharsex(Loc::getMessage('DATA_EE_VALUE_ANY'))?></option>
						<option value="Y"<?if($arFields["find_el_property_".$arProp["ID"]]=="Y")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_IS_NOT_EMPTY"))?></option>
						<option value="N"<?if($arFields["find_el_property_".$arProp["ID"]]=="N")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_IS_EMPTY"))?></option>
					</select>
				<?
				endif;
				?>
		...
		?>
			<tr>
				<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_FILTER_FROMTO_ID")?>:</td>
				<td nowrap>
			...
			?>
			<tr>
				<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_FIELD_TIMESTAMP_X")?>:</td>
			...
			<tr>
				<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_FIELD_ACTIVE")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_active]">
						<option value=""><?=htmlspecialcharsex(Loc::getMessage('DATA_EE_VALUE_ANY'))?></option>
						<option value="Y"<?if($arFields['find_sub_el_active']=="Y")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_YES"))?></option>
						<option value="N"<?if($arFields['find_sub_el_active']=="N")echo " selected"?>><?=htmlspecialcharsex(Loc::getMessage("DATA_EE_NO"))?></option>
					</select>
				</td>
			</tr>
			<tr>
				<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_FIELD_SORT")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_sort_comp]">
						<option value="eq" <?if($arFields['find_sub_el_sort_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
						<option value="gt" <?if($arFields['find_sub_el_sort_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
						<option value="geq" <?if($arFields['find_sub_el_sort_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
						<option value="lt" <?if($arFields['find_sub_el_sort_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
						<option value="leq" <?if($arFields['find_sub_el_sort_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
					</select>
			...
			<tr>
				<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_CATALOG_QUANTITY")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_catalog_quantity_comp]">
						<option value="eq" <?if($arFields['find_sub_el_catalog_quantity_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
						<option value="gt" <?if($arFields['find_sub_el_catalog_quantity_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
						<option value="geq" <?if($arFields['find_sub_el_catalog_quantity_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
						<option value="lt" <?if($arFields['find_sub_el_catalog_quantity_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
						<option value="leq" <?if($arFields['find_sub_el_catalog_quantity_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
					</select>
			...
			if(is_array($arStores))
			{
				foreach($arStores as $arStore)
				{
					?>
					<tr>
						<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').sprintf(Loc::getMessage("DATA_EE_CATALOG_STORE_QUANTITY"), $arStore['TITLE'])?>:</td>
						<td>
							<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_catalog_store<?echo $arStore['ID'];?>_quantity_comp]">
								<option value="eq" <?if($arFields['find_sub_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
								<option value="gt" <?if($arFields['find_sub_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
								<option value="geq" <?if($arFields['find_sub_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
								<option value="lt" <?if($arFields['find_sub_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
								<option value="leq" <?if($arFields['find_sub_el_catalog_store'.$arStore['ID'].'_quantity_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
							</select>
				...
				?>
					<tr>
						<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_CATALOG_STORE_ANY_QUANTITY")?>:</td>
						<td>
							...
							<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_catalog_store_any_quantity_comp]">
								<option value="eq" <?if($arFields['find_sub_el_catalog_store_any_quantity_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
								<option value="gt" <?if($arFields['find_sub_el_catalog_store_any_quantity_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
								<option value="geq" <?if($arFields['find_sub_el_catalog_store_any_quantity_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
								<option value="lt" <?if($arFields['find_sub_el_catalog_store_any_quantity_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
								<option value="leq" <?if($arFields['find_sub_el_catalog_store_any_quantity_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
							</select>
			...
			?>
			<tr>
				<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').Loc::getMessage("DATA_EE_CATALOG_PURCHASING_PRICE")?>:</td>
				<td>
					<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_catalog_purchasing_price_comp]">
						<option value="eq" <?if($arFields['find_sub_el_catalog_purchasing_price_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
						<option value="gt" <?if($arFields['find_sub_el_catalog_purchasing_price_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
						<option value="geq" <?if($arFields['find_sub_el_catalog_purchasing_price_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
						<option value="lt" <?if($arFields['find_sub_el_catalog_purchasing_price_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
						<option value="leq" <?if($arFields['find_sub_el_catalog_purchasing_price_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
						<option value="from_to" <?if($arFields['find_sub_el_catalog_purchasing_price_comp']=='from_to'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_FROM_TO')?></option>
					</select>
			...
			if(is_array($arPrices))
			{
				foreach($arPrices as $arPrice)
				{
					?>
					<tr>
						<td><?echo ('' != $strSKUName ? $strSKUName.' - ' : '').sprintf(Loc::getMessage("DATA_EE_CATALOG_PRICE"), $arPrice['NAME_LANG'])?>:</td>
						<td>
							<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_catalog_price_<?echo $arPrice['ID'];?>_comp]">
								<option value="eq" <?if($arFields['find_sub_el_catalog_price_'.$arPrice['ID'].'_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
								<option value="empty" <?if($arFields['find_sub_el_catalog_price_'.$arPrice['ID'].'_comp']=='empty'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EMPTY')?></option>
								<option value="gt" <?if($arFields['find_sub_el_catalog_price_'.$arPrice['ID'].'_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
								<option value="geq" <?if($arFields['find_sub_el_catalog_price_'.$arPrice['ID'].'_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
								<option value="lt" <?if($arFields['find_sub_el_catalog_price_'.$arPrice['ID'].'_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
								<option value="leq" <?if($arFields['find_sub_el_catalog_price_'.$arPrice['ID'].'_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
								<option value="from_to" <?if($arFields['find_sub_el_catalog_price_'.$arPrice['ID'].'_comp']=='from_to'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_FROM_TO')?></option>
							</select>
				...
				<tr>
					...
					<td>
						...
						<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_property_<?=$arProp["ID"]?>_comp]">
							<option value="eq" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
							<option value="neq" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='neq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_NEQ')?></option>
							<option value="contain" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='contain'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_CONTAIN')?></option>
							<option value="not_contain" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='not_contain'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_NOT_CONTAIN')?></option>
							<option value="empty" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='empty'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_IS_EMPTY')?></option>
							<option value="not_empty" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='not_empty'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_IS_NOT_EMPTY')?></option>
							<option value="logical" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='logical'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LOGICAL')?></option>
						</select>
						...
						<?elseif($arProp["PROPERTY_TYPE"]=='N'):?>
							<select name="SETTINGS[FILTER][<?=$listIndex?>][find_sub_el_property_<?=$arProp["ID"]?>_comp]">
								<option value="eq" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='eq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_EQ')?></option>
								<option value="gt" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='gt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GT')?></option>
								<option value="geq" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='geq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_GEQ')?></option>
								<option value="lt" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='lt'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LT')?></option>
								<option value="leq" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='leq'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_LEQ')?></option>
								<option value="from_to" <?if($arFields['find_sub_el_property_'.$arProp["ID"].'_comp']=='from_to'){echo 'selected';}?>><?=Loc::getMessage('DATA_EE_COMPARE_FROM_TO')?></option>
							</select>
			...
			foreach($rows as $listIndex=>$arRows)
			{
				if(is_array($rows[$listIndex]))
				{
					...
					foreach($rows[$listIndex] as $k=>$row)
					{
						...
						$row = preg_replace_callback('/\{DATE_(\S*)\}/', array('CDATAExportUtils', 'GetDateFormat'), $row);
						$row = preg_replace_callback('/\{RATE_SITE\.(\S*)\}/', array('CDATAExportUtils', 'GetCurrenyRateSite'), $row);
						$row = preg_replace_callback('/\{RATE_CBR\.(\S*)\}/', array('CDATAExportUtils', 'GetCurrenyRateCbr'), $row);
	...
	{
		return preg_replace_callback('/\{DATE_(\S*)\}/', array('CDATAExportUtils', 'GetDateFormat'), $name);
	}
