...
{
	$profileDB = new \Bitrix\DataExportexcel\ProfileTable();
...
if($storage=='db')
{
	class CDATAExportProfile extends CDATAExportProfileDB {}
...
{
	class CDATAExportProfile extends CDATAExportProfileFS {}
}

class CDATAExportProfileAll {
