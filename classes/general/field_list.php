...
class CDATAEEFieldList {
	function __construct($params = array())
	{
		$this->isSku = (bool)($params['IBLOCK_ID'] && CDATAExportUtils::GetOfferIblock($params['IBLOCK_ID']));
	...
	public static function GetIblockElementFields()
	{
		return array(
			"IE_NAME" => array(
				"name" => Loc::getMessage("DATA_EE_FI_NAME"),
				"sortable" => "Y"
			),
			"IE_ID" => array(
				"name" => Loc::getMessage("DATA_EE_FI_ID"),
				"sortable" => "Y"
			),
			"IE_XML_ID" => array(
				"name" => Loc::getMessage("DATA_EE_FI_UNIXML"),
				"sortable" => "Y"
			),
			"IE_CODE" => array(
				"name" => Loc::getMessage("DATA_EE_FI_CODE"),
				"sortable" => "Y"
			),
			"IE_PREVIEW_PICTURE" => array(
				"name" => Loc::getMessage("DATA_EE_FI_CATIMG"),
			),
			"IE_PREVIEW_PICTURE_DESCRIPTION" => array(
				"name" => Loc::getMessage("DATA_EE_FI_CATIMG_DESCRIPTION"),
			),
			"IE_PREVIEW_TEXT" => array(
				"name" => Loc::getMessage("DATA_EE_FI_CATDESCR"),
			),
			/*"IE_PREVIEW_TEXT|PREVIEW_TEXT_TYPE=html" => array(
				"name" => Loc::getMessage("DATA_EE_FI_CATDESCR").' (html)',
			),*/
			"IE_DETAIL_PICTURE" => array(
				"name" => Loc::getMessage("DATA_EE_FI_DETIMG"),
			),
			"IE_DETAIL_PICTURE_DESCRIPTION" => array(
				"name" => Loc::getMessage("DATA_EE_FI_DETIMG_DESCRIPTION"),
			),
			"IE_DETAIL_TEXT" => array(
				"name" => Loc::getMessage("DATA_EE_FI_DETDESCR"),
			),
			/*"IE_DETAIL_TEXT|DETAIL_TEXT_TYPE=html" => array(
				"name" => Loc::getMessage("DATA_EE_FI_DETDESCR").' (html)',
			),*/
			"IE_ACTIVE" => array(
				"name" => Loc::getMessage("DATA_EE_FI_ACTIV"),
				"sortable" => "Y"
			),
			"IE_ACTIVE_FROM" => array(
				"name" => Loc::getMessage("DATA_EE_FI_ACTIVFROM"),
				"sortable" => "Y"
			),
			"IE_ACTIVE_TO" => array(
				"name" => Loc::getMessage("DATA_EE_FI_ACTIVTO"),
				"sortable" => "Y"
			),
			"IE_SORT" => array(
				"name" => Loc::getMessage("DATA_EE_FI_SORT"),
				"sortable" => "Y"
			),
			"IE_TAGS" => array(
				"name" => Loc::getMessage("DATA_EE_FI_TAGS"),
				"sortable" => "Y"
			),
			"IE_DATE_CREATE" => array(
				"name" => Loc::getMessage("DATA_EE_FI_DATE_CREATE"),
			),
			"IE_CREATED_BY" => array(
				"name" => Loc::getMessage("DATA_EE_FI_CREATED_BY"),
			),
			"IE_TIMESTAMP_X" => array(
				"name" => Loc::getMessage("DATA_EE_FI_TIMESTAMP_X"),
			),
			"IE_MODIFIED_BY" => array(
				"name" => Loc::getMessage("DATA_EE_FI_MODIFIED_BY"),
			),
			"IE_SHOW_COUNTER" => array(
				"name" => Loc::getMessage("DATA_EE_FI_SHOW_COUNTER"),
			),
			"IE_DETAIL_PAGE_URL" => array(
				"name" => Loc::getMessage("DATA_EE_FI_DETAIL_PAGE_URL"),
			),
			"IE_QR_CODE_IMAGE" => array(
				"name" => Loc::getMessage("DATA_EE_QR_CODE_IMAGE"),
			),
		);
	}
	...
	public static function GetIblockSectionElementFields()
	{
		$arFields = array(
			'IE_SECTION_PATH' => array(
				"name" => Loc::getMessage("DATA_EE_FI_SECTION_PATH")
			)
		);
		return $arFields;
	}
	...
	public function GetIblockSectionFields($i, $IBLOCK_ID = false)
	{
		$arSections = array(
			'ISECT'.$i.'_NAME' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_NAME"),
				"sortable" => (strlen($i)==0 ? "Y" : "N")
			),
			'ISECT'.$i.'_CODE' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_CODE")
			),
			'ISECT'.$i.'_ID' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ID"),
				"sortable" => (strlen($i)==0 ? "Y" : "N")
			),
			'ISECT'.$i.'_XML_ID' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_XML_ID")
			),
			'ISECT'.$i.'_ACTIVE' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ACTIVE")
			),
			'ISECT'.$i.'_SORT' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SORT")
			),
			'ISECT'.$i.'_PICTURE' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_PICTURE")
			),
			'ISECT'.$i.'_DETAIL_PICTURE' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_DETAIL_PICTURE")
			),
			'ISECT'.$i.'_DESCRIPTION' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_DESCRIPTION"),
			) ,
			/*'ISECT'.$i.'_DESCRIPTION|DESCRIPTION_TYPE=html' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_DESCRIPTION").' (html)',
			) ,*/
			'ISECT'.$i.'_SECTION_PAGE_URL' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PAGE_URL"),
			),
			'ISECT'.$i.'_IPROP_TEMP_SECTION_META_TITLE' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_META_TITLE"),
			) ,
			'ISECT'.$i.'_IPROP_TEMP_SECTION_META_KEYWORDS' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_META_KEYWORDS"),
			) ,
			'ISECT'.$i.'_IPROP_TEMP_SECTION_META_DESCRIPTION' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_META_DESCRIPTION"),
			) ,
			'ISECT'.$i.'_IPROP_TEMP_SECTION_PAGE_TITLE' => array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PAGE_TITLE"),
			) , 
		);
		...
		if(strlen($i)==0)
		{
			/*$arSections['ISECT'.$i.'_IPROP_TEMP_SECTION_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_SECTION_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_SECTION_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PICTURE_FILE_NAME")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_SECTION_DETAIL_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_DETAIL_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_SECTION_DETAIL_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_DETAIL_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_SECTION_DETAIL_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_DETAIL_PICTURE_FILE_NAME")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_META_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_META_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_META_KEYWORDS'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_META_KEYWORDS")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_META_DESCRIPTION'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_META_DESCRIPTION")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_PAGE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_PAGE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_PREVIEW_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_PREVIEW_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_PREVIEW_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_PREVIEW_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_PREVIEW_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_PREVIEW_PICTURE_FILE_NAME")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_DETAIL_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_DETAIL_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_DETAIL_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_DETAIL_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_ELEMENT_DETAIL_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_ELEMENT_DETAIL_PICTURE_FILE_NAME")
			);*/
			
			
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_META_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_META_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_META_KEYWORDS'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_META_KEYWORDS")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_META_DESCRIPTION'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_META_DESCRIPTION")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_PAGE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_PAGE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_PICTURE_FILE_NAME")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_DETAIL_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_DETAIL_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_DETAIL_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_DETAIL_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_SECTION_DETAIL_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_SECTION_DETAIL_PICTURE_FILE_NAME")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_META_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_META_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_META_KEYWORDS'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_META_KEYWORDS")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_META_DESCRIPTION'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_META_DESCRIPTION")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_PAGE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_PAGE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_PREVIEW_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_PREVIEW_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_PREVIEW_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_PREVIEW_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_PREVIEW_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_PREVIEW_PICTURE_FILE_NAME")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_DETAIL_PICTURE_FILE_ALT'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_DETAIL_PICTURE_FILE_ALT")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_DETAIL_PICTURE_FILE_TITLE'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_DETAIL_PICTURE_FILE_TITLE")
			);
			$arSections['ISECT'.$i.'_IPROP_TEMP_TEMPLATE_ELEMENT_DETAIL_PICTURE_FILE_NAME'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_TEMPLATE_ELEMENT_DETAIL_PICTURE_FILE_NAME")
			);
			
			
			$arSections['ISECT'.$i.'_IBLOCK_SECTION_ID'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_IBLOCK_SECTION_ID")
			);
			$arSections['ISECT'.$i.'_DEPTH_LEVEL'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_DEPTH_LEVEL")
			);
			$arSections['ISECT'.$i.'_PATH_NAMES'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PATH_NAMES")
			);
			$arSections['ISECT'.$i.'_SECTION_PROPERTIES'] = array(
				"name" => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PROPERTIES")
			);
		}
			...
			if($arCatalog || $IBLOCK_ID===true)
			{
				$arSetFields = array(
					array(
						...
						"name" => Loc::getMessage("DATA_EE_FI_SET_ITEM"),
					),
					array(
						"value" => "ICAT_SET_QUANTITY",
						"name" => Loc::getMessage("DATA_EE_FI_SET_QUANTITY"),
					),
					array(
						"value" => "ICAT_SET_SORT",
						"name" => Loc::getMessage("DATA_EE_FI_SET_SORT"),
					),
				);
			}
		}
			...
			if($arCatalog || $IBLOCK_ID===true)
			{
				$arSetFields = array(
					array(
						...
						"name" => Loc::getMessage("DATA_EE_FI_SET2_ITEM"),
					),
					array(
						"value" => "ICAT_SET2_QUANTITY",
						"name" => Loc::getMessage("DATA_EE_FI_SET2_QUANTITY"),
					),
					array(
						"value" => "ICAT_SET2_DISCOUNT_PERCENT",
						"name" => Loc::getMessage("DATA_EE_FI_SET2_DISCOUNT_PERCENT"),
					),
					array(
						"value" => "ICAT_SET2_SORT",
						"name" => Loc::getMessage("DATA_EE_FI_SET2_SORT"),
					),
				);
			}
		}
	...
	public static function GetIblockProperties($IBLOCK_ID, $arParams=array())
	{
		...
		if(!empty($arProperties))
		{
			array_unshift($arProperties, array(
				"value" => "IP_LIST_PROPS",
				"name" => Loc::getMessage("DATA_EE_FI_PROP_LIST"),
				"wdesc" => false,
				"sortable" => "N"
			));
		}
	...
	{
		return array(
			"IPROP_TEMP_ELEMENT_META_TITLE" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_META_TITLE"),
			"IPROP_TEMP_ELEMENT_META_KEYWORDS" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_META_KEYWORDS"),
			"IPROP_TEMP_ELEMENT_META_DESCRIPTION" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_META_DESCRIPTION"),
			"IPROP_TEMP_ELEMENT_PAGE_TITLE" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_PAGE_TITLE"),
			"IPROP_TEMP_ELEMENT_PREVIEW_PICTURE_FILE_ALT" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_PREVIEW_PICTURE_FILE_ALT"),
			"IPROP_TEMP_ELEMENT_PREVIEW_PICTURE_FILE_TITLE" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_PREVIEW_PICTURE_FILE_TITLE"),
			"IPROP_TEMP_ELEMENT_PREVIEW_PICTURE_FILE_NAME" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_PREVIEW_PICTURE_FILE_NAME"),
			"IPROP_TEMP_ELEMENT_DETAIL_PICTURE_FILE_ALT" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_DETAIL_PICTURE_FILE_ALT"),
			"IPROP_TEMP_ELEMENT_DETAIL_PICTURE_FILE_TITLE" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_DETAIL_PICTURE_FILE_TITLE"),
			"IPROP_TEMP_ELEMENT_DETAIL_PICTURE_FILE_NAME" => Loc::getMessage("DATA_EE_IPROP_ELEMENT_DETAIL_PICTURE_FILE_NAME"),
			"IPROP_TEMP_CH_ELEMENT_META_TITLE" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_META_TITLE"),
			"IPROP_TEMP_CH_ELEMENT_META_KEYWORDS" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_META_KEYWORDS"),
			"IPROP_TEMP_CH_ELEMENT_META_DESCRIPTION" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_META_DESCRIPTION"),
			"IPROP_TEMP_CH_ELEMENT_PAGE_TITLE" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_PAGE_TITLE"),
			"IPROP_TEMP_CH_ELEMENT_PREVIEW_PICTURE_FILE_ALT" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_PREVIEW_PICTURE_FILE_ALT"),
			"IPROP_TEMP_CH_ELEMENT_PREVIEW_PICTURE_FILE_TITLE" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_PREVIEW_PICTURE_FILE_TITLE"),
			"IPROP_TEMP_CH_ELEMENT_PREVIEW_PICTURE_FILE_NAME" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_PREVIEW_PICTURE_FILE_NAME"),
			"IPROP_TEMP_CH_ELEMENT_DETAIL_PICTURE_FILE_ALT" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_DETAIL_PICTURE_FILE_ALT"),
			"IPROP_TEMP_CH_ELEMENT_DETAIL_PICTURE_FILE_TITLE" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_DETAIL_PICTURE_FILE_TITLE"),
			"IPROP_TEMP_CH_ELEMENT_DETAIL_PICTURE_FILE_NAME" => Loc::getMessage("DATA_EE_IPROP_CH_ELEMENT_DETAIL_PICTURE_FILE_NAME"),
		);
	}
		...
		if(Loader::includeModule('catalog'))
		{
			...
			if($arCatalog)
			{
				$arCatalogFields[] = array(
					...
					"name" => Loc::getMessage("DATA_EE_FI_PURCHASING_PRICE"),
				);
				$arCatalogFields[] = array(
					"value" => "ICAT_PURCHASING_CURRENCY",
					"name" => Loc::getMessage("DATA_EE_FI_PRICE_CURRENCY").' "'.Loc::getMessage("DATA_EE_FI_PURCHASING_PRICE").'"',
				);
				...
				while($arPriceType = $dbPriceType->Fetch())
				{
					$arCatalogFields[] = array(
						...
						"name" => Loc::getMessage("DATA_EE_FI_PRICE_NAME").' "'.($arPriceType["NAME_LANG"] ? $arPriceType["NAME_LANG"] : $arPriceType["NAME"]).'"',
						"sortable" => "Y"
					);
					$arCatalogFields[] = array(
						"value" => "ICAT_PRICE".$arPriceType["ID"]."_PRICE_DISCOUNT",
						"name" => Loc::getMessage("DATA_EE_FI_PRICE_NAME").' "'.($arPriceType["NAME_LANG"] ? $arPriceType["NAME_LANG"] : $arPriceType["NAME"]).'" '.Loc::getMessage("DATA_EE_FI_PRICE_WITH_DISCOUNT"),
					);
					$arCatalogFields[] = array(
						"value" => "ICAT_PRICE".$arPriceType["ID"]."_CURRENCY",
						"name" => Loc::getMessage("DATA_EE_FI_PRICE_CURRENCY").' "'.($arPriceType["NAME_LANG"] ? $arPriceType["NAME_LANG"] : $arPriceType["NAME"]).'"',
					);
					$arCatalogFields[] = array(
						"value" => "ICAT_PRICE".$arPriceType["ID"]."_PRICE_EXT",
						"name" => Loc::getMessage("DATA_EE_FI_PRICE_NAME").' "'.($arPriceType["NAME_LANG"] ? $arPriceType["NAME_LANG"] : $arPriceType["NAME"]).'" - '.Loc::getMessage("DATA_EE_FI_PRICE_EXT_MODE"),
						"sortable" => "Y"
					);
					if($arPriceType['BASE']!='Y')
					{
						$arCatalogFields[] = array(
							...
							"name" => Loc::getMessage("DATA_EE_FI_PRICE_EXTRA").' "'.($arPriceType["NAME_LANG"] ? $arPriceType["NAME_LANG"] : $arPriceType["NAME"]).'" ('.Loc::getMessage("DATA_EE_FI_PRICE_EXTRA_MEASURE").')',
						);
						$arCatalogFields[] = array(
							"value" => "ICAT_PRICE".$arPriceType["ID"]."_EXTRA_NAME",
							"name" => Loc::getMessage("DATA_EE_FI_PRICE_EXTRA_NAME").' "'.($arPriceType["NAME_LANG"] ? $arPriceType["NAME_LANG"] : $arPriceType["NAME"]).'"',
						);
						$arCatalogFields[] = array(
							"value" => "ICAT_PRICE".$arPriceType["ID"]."_EXTRA_ID",
							"name" => Loc::getMessage("DATA_EE_FI_PRICE_EXTRA_ID").' "'.($arPriceType["NAME_LANG"] ? $arPriceType["NAME_LANG"] : $arPriceType["NAME"]).'"',
						);
					}
				}
				...
				$arCatalogFields[] = array(
					"value" => "ICAT_QUANTITY",
					"name" => Loc::getMessage("DATA_EE_FI_QUANTITY"),
					"sortable" => "Y"
				);
				$arCatalogFields[] = array(
					"value" => "ICAT_QUANTITY_RESERVED",
					"name" => Loc::getMessage("DATA_EE_FI_QUANTITY_RESERVED"),
				);
				...
				while($arStore = $dbRes->Fetch())
				{
					...
					$arCatalogFields[] = array(
						...
						"name" => Loc::getMessage("DATA_EE_FI_QUANTITY_STORE").' "'.$arStore["TITLE"].'"'
					);
				}
				
				$arCatalogFields[] = array(
					"value" => "ICAT_WEIGHT",
					"name" => Loc::getMessage("DATA_EE_FI_WEIGHT"),
					"sortable" => "Y"
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_LENGTH",
					"name" => Loc::getMessage("DATA_EE_FI_LENGTH"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_WIDTH",
					"name" => Loc::getMessage("DATA_EE_FI_WIDTH"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_HEIGHT",
					"name" => Loc::getMessage("DATA_EE_FI_HEIGHT"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_MEASURE",
					"name" => Loc::getMessage("DATA_EE_FI_MEASURE"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_MEASURE_RATIO",
					"name" => Loc::getMessage("DATA_EE_FI_MEASURE_RATIO"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_VAT_INCLUDED",
					"name" => Loc::getMessage("DATA_EE_FI_VAT_INCLUDED"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_VAT_ID",
					"name" => Loc::getMessage("DATA_EE_FI_VAT_ID"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_BARCODE",
					"name" => Loc::getMessage("DATA_EE_FI_BARCODE"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_QUANTITY_TRACE",
					"name" => Loc::getMessage("DATA_EE_FI_QUANTITY_TRACE"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_CAN_BUY_ZERO",
					"name" => Loc::getMessage("DATA_EE_FI_CAN_BUY_ZERO"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_NEGATIVE_AMOUNT_TRACE",
					"name" => Loc::getMessage("DATA_EE_FI_NEGATIVE_AMOUNT_TRACE"),
				);
				
				$arCatalogFields[] = array(
					"value" => "ICAT_SUBSCRIBE",
					"name" => Loc::getMessage("DATA_EE_FI_SUBSCRIBE"),
				);
			}
		}
			...
			if($arCatalog)
			{
				$arDiscountFields = array(
					array(
						...
						"name" => Loc::getMessage("DATA_EE_FI_DISCOUNT_PERCENT"),
					),
					array(
						"value" => "ICAT_DISCOUNT_VALUE|VALUE_TYPE=F",
						"name" => Loc::getMessage("DATA_EE_FI_DISCOUNT_SUM"),
					),
					array(
						"value" => "ICAT_DISCOUNT_VALUE|VALUE_TYPE=S",
						"name" => Loc::getMessage("DATA_EE_FI_DISCOUNT_PRICE"),
					)
				);
			}
		}
			...
			if($arCatalog)
			{
				$arOrderFields = array(
					array(
						...
						"name" => Loc::getMessage("DATA_EE_FI_ORDER_PRODUCT_QNT"),
					)
				);
			}
		}
	...
	public function GetFields($IBLOCK_ID, $offers = false, $arParams = array())
	{
		...
		if(!$this->aFields[$ikey])
		{
			$this->aFields[$ikey]['element'] = array(
				'title' => ($offers ? Loc::getMessage("DATA_EE_GROUP_OFFER") : Loc::getMessage("DATA_EE_GROUP_ELEMENT")),
				'items' => array()
			);
			...
			if($arPropFields = self::GetIblockProperties($IBLOCK_ID, $arParams))
			{
				$this->aFields[$ikey]['prop'] = array(
					'title' => ($offers ? Loc::getMessage("DATA_EE_GROUP_OFFER").' ('.Loc::getMessage("DATA_EE_GROUP_PROP").')' : Loc::getMessage("DATA_EE_GROUP_PROP")),
					'items' => array()
				);
				foreach($arPropFields as $ar)
				{
					...
					if($ar["wdesc"])
					{
						$this->aFields[$ikey]['prop']['items'][$ar["value"].'_DESCRIPTION'] = $ar["name"].' ('.Loc::getMessage("DATA_EE_PROP_DESCRIPTION").')';
					}
				}
			}
			...
			if($arIpropTempFields = self::GetIblockIpropTemplates())
			{
				$this->aFields[$ikey]['iprop_temp'] = array(
					'title' => ($offers ? Loc::getMessage("DATA_EE_GROUP_OFFER").' ('.Loc::getMessage("DATA_EE_IPROP_TEMPLATES").')' : Loc::getMessage("DATA_EE_IPROP_TEMPLATES")),
					'items' => array()
				);
			...
			if($arCatalogFields = self::GetCatalogFields($IBLOCK_ID))
			{
				$this->aFields[$ikey]['catalog'] = array(
					'title' => ($offers ? Loc::getMessage("DATA_EE_GROUP_OFFER").' ('.Loc::getMessage("DATA_EE_GROUP_CATALOG").')' : Loc::getMessage("DATA_EE_GROUP_CATALOG")),
					'items' => array()
				);
			...
			if(!$offers)
			{
				...
				$this->aFields[$ikey]['section'] = array(
					'title' => Loc::getMessage("DATA_EE_GROUP_SECTION_PARENT"),
					'items' => array()
				);
				...
				for($i=1; $i<$this->sectionLevels+1; $i++)
				{
					$this->aFields[$ikey]['section'.$i] = array(
						'title' => sprintf(Loc::getMessage("DATA_EE_GROUP_SECTION_LEVEL"), $i),
						'items' => array()
					);
			...
			if($arDiscountFields = self::GetCatalogDiscountFields($IBLOCK_ID))
			{
				$this->aFields[$ikey]['catalog_discount'] = array(
					'title' => ($offers ? Loc::getMessage("DATA_EE_GROUP_OFFER").' ('.Loc::getMessage("DATA_EE_GROUP_CATALOG_DISCOUNT").')' : Loc::getMessage("DATA_EE_GROUP_CATALOG_DISCOUNT")),
					'items' => array()
				);
			...
			if(!$offers && ($arCatalogSetFields = self::GetCatalogSetFields($IBLOCK_ID)))
			{
				$this->aFields[$ikey]['catalog_set'] = array(
					'title' => Loc::getMessage("DATA_EE_GROUP_CATALOG_SET"),
					'items' => array()
				);
			...
			if(!$offers && ($arCatalogSetFields = self::GetCatalogSet2Fields($IBLOCK_ID)))
			{
				$this->aFields[$ikey]['catalog_set2'] = array(
					'title' => Loc::getMessage("DATA_EE_GROUP_CATALOG_SET2"),
					'items' => array()
				);
				foreach($arCatalogSetFields as $ar)
				{
			...
			if($arOrderFields = self::GetSaleOrderFields($IBLOCK_ID))
			{
				$this->aFields[$ikey]['sale_order'] = array(
					'title' => ($offers ? Loc::getMessage("DATA_EE_GROUP_OFFER").' ('.Loc::getMessage("DATA_EE_GROUP_SALE_ORDER").')' : Loc::getMessage("DATA_EE_GROUP_SALE_ORDER")),
					'items' => array()
				);
	...
	public function GetRelatedFields($IBLOCK_ID, $value)
	{
		...
		if(!$this->aRelatedFields[$IBLOCK_ID])
		{
			$this->aRelatedFields[$IBLOCK_ID]['element'] = array(
				'title' => Loc::getMessage("DATA_EE_GROUP_ELEMENT"),
				'items' => array()
			);
			foreach(self::GetIblockElementFields() as $k=>$ar)
			{
			...
			if($arPropFields = self::GetIblockProperties($IBLOCK_ID))
			{
				$this->aRelatedFields[$IBLOCK_ID]['prop'] = array(
					'title' => Loc::getMessage("DATA_EE_GROUP_PROP"),
					'items' => array()
				);
				foreach($arPropFields as $ar)
				{
	...
	public function GetRelatedSectionFields($IBLOCK_ID, $value)
	{
		...
		if(!$this->aRelatedSectionFields[$IBLOCK_ID])
		{
			$this->aRelatedSectionFields[$IBLOCK_ID] = array(
				'NAME' => Loc::getMessage("DATA_EE_ISECT_FI_NAME"),
				'ID'=> Loc::getMessage("DATA_EE_ISECT_FI_ID"),
				'CODE' => Loc::getMessage("DATA_EE_ISECT_FI_CODE"),
				'XML_ID' => Loc::getMessage("DATA_EE_ISECT_FI_XML_ID"),
				'SORT' => Loc::getMessage("DATA_EE_ISECT_FI_SORT"),
				'PICTURE' => Loc::getMessage("DATA_EE_ISECT_FI_PICTURE"),
				'DETAIL_PICTURE' => Loc::getMessage("DATA_EE_ISECT_FI_DETAIL_PICTURE"),
				'DESCRIPTION' => Loc::getMessage("DATA_EE_ISECT_FI_DESCRIPTION"),
				'SECTION_PAGE_URL' => Loc::getMessage("DATA_EE_ISECT_FI_SECTION_PAGE_URL")
			);
	...
	public function ShowSelectFields($IBLOCK_ID, $fname, $value="", $arParams=array())
	{
		...
		if($this->isSku)
		{
			$arOffer = CDATAExportUtils::GetOfferIblock($IBLOCK_ID, true);
		...
		else{?><select name="<?echo $fname;?>"><option value=""><?echo Loc::getMessage("DATA_EE_CHOOSE_FIELD");?></option><?}
		foreach($arGroups as $k2=>$v2)
		{
	...
	public function ShowSelectFieldsHighload($HIGHLOADBLOCK_ID, $fname, $value="")
	{
		...
		?><select name="<?echo $fname;?>"><option value=""><?echo Loc::getMessage("DATA_EE_CHOOSE_FIELD");?></option><?
		?><optgroup label="<?echo Loc::getMessage("DATA_EE_HIGHLOAD_FIELDS")?>"><?
	...
	public function GetSettingsFieldsHighload($HLBL_ID)
	{
		...
		$arFields['HLBL_FIELDS'] = array(
			'TITLE' => Loc::getMessage("DATA_EE_HIGHLOAD_FIELDS"),
			'FIELDS' => $arHlblFields
		);
		return $arFields;
	}
