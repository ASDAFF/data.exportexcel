...
<form action="" method="post" enctype="multipart/form-data">
	...
	<table width="100%">
		...
		?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo Loc::getMessage("DATA_EE_IP_DATE_FORMAT");?>:</td>
				<td class="adm-detail-content-cell-r">
					...
					if($prop['ADDITIONAL_VALUES']!=='N')
						$res .= '<option value="">'.Loc::getMessage("DATA_EE_IP_PROP_OTHER").'</option>';
		...
		elseif($code=='CURRENCY_RATE')
		{
			...
			{
				$arCurrency = array(
					'USD'=>Loc::getMessage("DATA_EE_IP_CURRENCY_USD"),
					'EUR'=>Loc::getMessage("DATA_EE_IP_CURRENCY_EUR")
				);
			}
		?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo Loc::getMessage("DATA_EE_IP_CURRENCY");?>:</td>
				<td class="adm-detail-content-cell-r">
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo Loc::getMessage("DATA_EE_IP_CURRENCY_TYPE");?>:</td>
				<td class="adm-detail-content-cell-r">
					<select name="CURRENCY_TYPE">
						<?if($bCurrency){?><option value="SITE"><?echo Loc::getMessage("DATA_EE_IP_CURRENCY_TYPE_SITE");?></option><?}?>
						<option value="CBR"><?echo Loc::getMessage("DATA_EE_IP_CURRENCY_TYPE_CBR");?></option>
					</select>				
				</td>
			</tr>
		<?}?>
