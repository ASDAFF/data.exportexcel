...
<form action="" method="post" enctype="multipart/form-data" name="field_settings">
	...
	<table width="100%" class="data-ee-fl-settings">		
		<tr>
			<td colspan="2">
				<table width="100%" class="data-ee-fl-settings-select">
					<tr>
						<td>
							<b><?echo GetMessage("DATA_EE_AVAILABLE_FIELDS");?></b>
						</td>
						<td></td>
						<td>
							<b><?echo GetMessage("DATA_EE_SELECTED_FIELDS");?></b>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<input name="add" value="&nbsp; > &nbsp;" title="<?echo GetMessage("DATA_EE_SELECT_CHECKED_FIELDS");?>" type="button">
						</td>
						<td>
						...
						<td>
							<input name="up" class="button" value="<?echo GetMessage("DATA_EE_ABOVE");?>" title="<?echo GetMessage("DATA_EE_FIELDS_ORDER_ABOVE");?>" type="button" disabled><br>
							<input name="down" class="button" value="<?echo GetMessage("DATA_EE_BELOW");?>" title="<?echo GetMessage("DATA_EE_FIELDS_ORDER_BELOW");?>" type="button" disabled><br>
							<input name="del" class="button" value="<?echo GetMessage("DATA_EE_REMOVE");?>" title="<?echo GetMessage("DATA_EE_REMOVE_FIELDS");?>" type="button" disabled><br>
						</td>
					</tr>
				</table>
			</td>
