...
if($bUserIsAdmin || $bHasWRight)
{
	...
	{
		$aSubMenu[] = array(
			"text" => GetMessage("DATA_MENU_EXPORT_TITLE_HIGHLOAD"),
			"url" => $moduleFilePrefix."_highload.php?lang=".LANGUAGE_ID,
			"title" => GetMessage("DATA_MENU_EXPORT_TITLE_HIGHLOAD"),
			"module_id" => $moduleId,
	...
	$aMenu[] = array(
		...
		"section" => $moduleIdUl,
		"sort" => 1401,
		"text" => GetMessage("DATA_MENU_EXPORT_TITLE_PARENT"),
		"title" => GetMessage("DATA_MENU_EXPORT_TITLE_PARENT"),
