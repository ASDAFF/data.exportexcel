...
<form action="" method="post" enctype="multipart/form-data" name="field_settings">
	...
	<table width="100%">
		...
		<?if($fieldKey=='SECTION_PATH'){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_SECTION_PATH_SEPARATOR");?>:</td>
		...
		<?if(strpos($fieldKey, 'TEXT_ROWS_TOP')===0){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_HIDE_UNDER_GROUP");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<tr>
			<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_ROW_HEIGHT"); ?>:</td>
			<td class="adm-detail-content-cell-r">
				<?
		...
		<?if($fieldType!='image'){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_FONT_FAMILY");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_FONT_SIZE");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_FONT_COLOR");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_BACKGROUND_COLOR");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_FONT_STYLE_BOLD");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_FONT_STYLE_ITALIC");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<?if($fieldType=='image'){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_PICTURE_WIDTH");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("DATA_EE_DISPLAY_SETTING_PICTURE_HEIGHT");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
